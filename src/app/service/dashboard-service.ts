...
// //   private baseUrl = 'https://dev.smartassistapp.in/api/
...
@Injectable({ providedIn: 'root' })
export class DashboardService {
  private baseUrl = 'https://dev.smartassistapp.in/api/superAdmin/dashboard';
  ...
  getDealers(
    ...
    return this.http.get(
      `https://dev.smartassistapp.in/api/superAdmin/dashboard/NoSM?type=${filter}`,
      {
  ...
  //   return this.http.get(
  //     `https://dev.smartassistapp.in/api/superAdmin/dashboard/NoSM?start_date=${startDate}&end_date=${endDate}`,
  //     { headers: { Authorization: `Bearer ${token}` } }
  //   );
  // }
  getDealersByCustomDate(
    ...
    let url = `https://dev.smartassistapp.in/api/superAdmin/dashboard/NoSM?start_date=${startDate}&end_date=${endDate}`;

    if (dealerId) {
      url = `https://dev.smartassistapp.in/api/superAdmin/dashboard/NoSM?dealer_id=${dealerId}&start_date=${startDate}&end_date=${endDate}`;
    }
  ...
  getCustomUsers(
    ...
    const url = `https://dev.smartassistapp.in/api/superAdmin/dashboard/NoSM?dealer_id=${dealerId}&start_date=${startDate}&end_date=${endDate}`;
    return this.http.get(url, {
      headers: { Authorization: `Bearer ${token}` },
    });
  }
  getKpiData(token: string, type: string = 'MTD') {
    const url = `https://dev.smartassistapp.in/api/superAdmin/dashboard/NoSM?type=${type}`;
    return this.http.get(url, {
      headers: { Authorization: `Bearer ${token}` },
    });
  }
