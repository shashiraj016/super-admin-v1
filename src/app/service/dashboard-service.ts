...
export class DashboardService {
  ...
  getDealersByCustomDate(
    ...
    let url = `https://api.prod.smartassistapp.in/api/superAdmin/dashboard/NoSM?start_date=${startDate}&end_date=${endDate}`;

    if (dealerId) {
      url = `https://api.prod.smartassistapp.in/api/superAdmin/dashboard/NoSM?dealer_id=${dealerId}&start_date=${startDate}&end_date=${endDate}`;
    }
  ...
  getCustomUsers(
    ...
    const url = `https://api.prod.smartassistapp.in/api/superAdmin/dashboard/NoSM?dealer_id=${dealerId}&start_date=${startDate}&end_date=${endDate}`;
    return this.http.get(url, {
      headers: { Authorization: `Bearer ${token}` },
    });
  }
