...
// node_modules/ng-circle-progress/fesm2015/ng-circle-progress.mjs
  ...
  constructor(defaultOptions, ngZone, elRef, injector) {
    ...
    this.animate = (previousPercent, currentPercent) => {
      ...
      if (fromPercent < toPercent) {
        this._timerSubscription = (0, import_rxjs.timer)(0, interval).subscribe(() => {
          count += step;
          if (count <= toPercent) {
    ...
    this.loadEventsForLazyMode = () => {
      if (this.options.lazy) {
        ...
        let _timer = (0, import_rxjs.timer)(0, 50).subscribe(() => {
