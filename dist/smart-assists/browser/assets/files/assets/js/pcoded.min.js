    ...
    o = {
          ...
          ("expanded" !== satnt && "compact" !== satnt) ||
            ...
            "click" === mt &&
              $("#mobile-collapse,#mobile-collapse1").click(function (e) {
                ...
                (rel = t.attr("rel")),
                  (el = $(".pcoded-navbar")),
                  "collapsed" == $("#pcoded").attr("vertical-nav-type")
                    ? ($(".main-menu").slimScroll({ destroy: !0 }),
      ...
      HandleHorizontalItemAlignment: function () {
        "horizontal" === e.themelayout &&
          ...
          (function () {
            var a = $(
              "#" + t + ".pcoded .pcoded-navbar .pcoded-item.pcoded-left-item"
            );
          ...
          (function () {
            var a = $(
              "#" + t + ".pcoded .pcoded-navbar .pcoded-item.pcoded-right-item"
            );
          ...
          case "horizontal":
            1 == a
              ? ($("#" + t + " .pcoded-navbar").attr(
                ...
                $("#" + t + " .pcoded-header .pcoded-left-header").attr(
      ...
      HandleActiveItemStyle: function () {
        ...
        void 0 != a && "" != a
          ? $("#" + t + " .pcoded-navbar").attr("active-item-style", a)
          : $("#" + t + " .pcoded-navbar").attr("active-item-style", "style0");
      },
        ...
        !(function () {
          ...
          (function () {
            var a = e.HeaderBackground,
              o = e.LogoTheme;
            void 0 != a && "" != a
              ? $("#" + t + " .pcoded-header").attr("header-theme", a)
              : $("#" + t + " .pcoded-header").attr("header-theme", "theme1"),
              void 0 != o && "" != o
                ? $("#" + t + " .navbar-logo").attr("logo-theme", o)
                : $("#" + t + " .navbar-logo").attr("logo-theme", "theme1");
          })(),
          (function () {
          ...
          (function () {
            ...
            void 0 != a && "" != a
              ? $("#" + t + " .pcoded-navbar").attr("navbar-theme", a)
              : $("#" + t + " .pcoded-navbar").attr("navbar-theme", "theme1");
          })(),
          (function () {
            var a = e.ActiveItemBackground;
            void 0 != a && "" != a
              ? $("#" + t + " .pcoded-navbar").attr("active-item-theme", a)
              : $("#" + t + " .pcoded-navbar").attr(
                  "active-item-theme",
                  "theme1"
                );
          ...
          (function () {
            ...
            void 0 != a && "" != a
              ? $("#" + t + " .pcoded-navbar").attr("sub-item-theme", a)
              : $("#" + t + " .pcoded-navbar").attr("sub-item-theme", "theme1");
          })();
      },
      ...
      HandleSubMenuTrigger: function () {
        ...
        switch (e.SubMenuTrigger) {
          case "hover":
            ...
            break;
          case "click":
            $("#" + t + " .pcoded-navbar .pcoded-hasmenu").removeClass(
              "is-hover"
            ),
          ...
          ? $(
              ...
              if ("desktop" == a) {
                ...
                c == r
                  ...
                  : d == o && $("#" + t).attr("vertical-nav-type", r);
              } else if ("phone" == a) {
                ...
                p == s
                  ...
                  : d == o && $("#" + t).attr("vertical-nav-type", s);
              }
          ...
          if ("vertical" === e.themelayout)
            if (a >= 768 && a <= 992) {
              ...
              void 0 != o && "" != o
                ...
                : $("#" + t).attr("vertical-nav-type", "collapsed");
              ...
              void 0 != o && "" != o
                ? $("#" + t).attr("vertical-nav-type", o)
                : $("#" + t).attr("vertical-nav-type", "offcanvas");
              ...
              void 0 != o && "" != o
                ? $("#" + t).attr("vertical-nav-type", o)
                : $("#" + t).attr("vertical-nav-type", "expanded");
