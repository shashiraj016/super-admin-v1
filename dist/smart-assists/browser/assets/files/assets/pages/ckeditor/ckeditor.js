(function () {
  (window.CKEDITOR && window.CKEDITOR.dom) ||
          ...
          on: function (b, e, f, l, d) {
            ...
            if (0 > g.getListenerIndex(e)) {
              ...
              for (var w = g.length - 1; 0 <= w; w--)
                if (g[w].priority <= d)
                  return g.splice(w + 1, 0, h), { removeListener: k };
              g.unshift(h);
            }
          ...
          fire: (function () {
            ...
            return function (d, h, k) {
              ...
              if (g) {
                var w = g.listeners;
                if (w.length)
                  for (var w = w.slice(0), q, v = 0; v < w.length; v++) {
                    if (g.errorProof)
                      try {
                        q = w[v].call(this, k, h, b, l);
                      } catch (u) {}
                    else q = w[v].call(this, k, h, b, l);
                    !1 === q ? (m = 1) : "undefined" != typeof q && (h = q);
                    if (a || m) break;
                  }
              }
    ...
    (CKEDITOR.warn = function (a, f) {
      CKEDITOR.verbosity & CKEDITOR.VERBOSITY_WARN &&
        CKEDITOR.fire("log", { type: "warn", errorCode: a, additionalData: f });
    }),
      ...
      function (a) {
        if (window.console && window.console.log) {
          ...
          if ((a = a.data.additionalData))
            console[f]("[CKEDITOR] Error code: " + b + ".", a);
      ...
      CKEDITOR.tools = {
        ...
        extend: function (a) {
          var g = arguments.length,
            d,
            b;
          "boolean" == typeof (d = arguments[g - 1])
            ? g--
            : "boolean" == typeof (d = arguments[g - 2]) &&
              ((b = arguments[g - 1]), (g -= 2));
          for (var h = 1; h < g; h++) {
            var c = arguments[h],
              e;
        ...
        buildStyleHtml: function (a) {
          ...
          for (var g, d = [], b = 0; b < a.length; b++)
            if ((g = a[b]))
              /@import|[{}]/.test(g)
                ? d.push("\x3cstyle\x3e" + g + "\x3c/style\x3e")
                : d.push(
            ...
            var c = g,
              g = function () {
                ...
                for (g in b) {
                  var d = b[g];
                  a[g] =
                    "function" == typeof d ? CKEDITOR.tools.bind(d, this) : d;
                }
                c.apply(this, arguments);
              };
          d &&
            ((g.prototype = this.prototypedCopy(d.prototype)),
            (g.prototype.constructor = g),
            (g.base = d),
            (g.baseProto = d.prototype),
        ...
        parseCssText: function (a, g, d) {
          ...
          a.replace(/&quot;/g, '"').replace(
            ...
            function (a, d, k) {
              g &&
                ((d = d.toLowerCase()),
                "font-family" == d && (k = k.replace(/\s*,\s*/g, ",")),
        ...
        getCookie: function (a) {
          a = a.toLowerCase();
          for (
            var g = document.cookie.split(";"), d, b, h = 0;
            h < g.length;
            h++
          )
            if (
              ((d = g[h].split("\x3d")),
              (b = decodeURIComponent(CKEDITOR.tools.trim(d[0]).toLowerCase())),
              b === a)
            )
              return decodeURIComponent(1 < d.length ? d[1] : "");
          return null;
        },
        ...
        style: {
          parse: {
            ...
            background: function (a) {
              ...
              d.length &&
                ((g.color = d[0]),
                CKEDITOR.tools.array.forEach(d, function (g) {
                  a = a.replace(g, "");
                }));
    ...
    (CKEDITOR.dtd = (function () {
      var a = CKEDITOR.tools.extend,
        f = function (a, g) {
          for (
            var d = CKEDITOR.tools.clone(a), b = 1;
            b < arguments.length;
            b++
          ) {
            g = arguments[b];
        ...
        on: function (f) {
          ...
          b[f] ||
            ...
            this.$.addEventListener
              ? this.$.addEventListener(f, b, !!CKEDITOR.event.useCapture)
              : this.$.attachEvent && this.$.attachEvent("on" + f, b));
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
      ...
      getAddress: function (a) {
        for (
          var f = [], b = this.getDocument().$.documentElement, c = this.$;
          c && c != b;
      ...
      getIndex: function (a) {
        ...
        if (
          !this.$.parentNode ||
          (a && c.nodeType == CKEDITOR.NODE_TEXT && b(c) && !f(c) && !f(c, !0))
        )
          return -1;
        do
          (a &&
            ...
            (m || b(c))) ||
            (e++, (m = c.nodeType == CKEDITOR.NODE_TEXT));
      ...
      getPosition: function (a) {
        ...
        if (
          ...
          if ("sourceIndex" in f)
            return 0 > f.sourceIndex || 0 > b.sourceIndex
      ...
      ltrim: function () {
        for (var a; this.getFirst && (a = this.getFirst()); ) {
          if (a.type == CKEDITOR.NODE_TEXT) {
            ...
            if (f)
              f.length < b &&
                (a.split(b - f.length), this.$.removeChild(this.$.firstChild));
            else {
              a.remove();
              continue;
            }
      ...
      isReadOnly: function (a) {
        ...
        if (!a && f && "undefined" != typeof f.$.isContentEditable)
          return !(f.$.isContentEditable || f.data("cke-editable"));
        for (; f; ) {
          if (f.data("cke-editable")) return !1;
          if (f.hasAttribute("contenteditable"))
            return "false" == f.getAttribute("contenteditable");
          f = f.getParent();
        }
        return !0;
      },
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.window.prototype, {
      ...
      getViewPaneSize: function () {
        ...
        return {
          ...
          height:
            (f ? a.documentElement.clientHeight : a.body.clientHeight) || 0,
        };
      },
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
      ...
      getByAddress: function (a, f) {
        for (var b = this.$.documentElement, c = 0; b && c < a.length; c++) {
          var e = a[c];
          if (f)
            for (var m = -1, l = 0; l < b.childNodes.length; l++) {
              var d = b.childNodes[l];
              if (
                !0 !== f ||
                3 != d.nodeType ||
                !d.previousSibling ||
                3 != d.previousSibling.nodeType
              )
                if ((m++, m == e)) {
                  b = d;
                  break;
    ...
    (function () {
      ...
      function c(a) {
        for (var b = 0, c = 0, g = l[a].length; c < g; c++)
      ...
      CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
        ...
        mergeSiblings: (function () {
          function a(b, d, g) {
            if (d && d.type == CKEDITOR.NODE_ELEMENT) {
              for (
                var c = [];
                d.data("cke-bookmark") || d.isEmptyInlineRemoveable();

              )
                if (
                  (c.push(d),
                  (d = g ? d.getNext() : d.getPrevious()),
        ...
        getDocumentPosition: function (a) {
          ...
          if (
            ...
            var m = this.$.getBoundingClientRect(),
              l = g.$.documentElement,
              u = l.clientTop || e.$.clientTop || 0,
              r = l.clientLeft || e.$.clientLeft || 0,
              p = !0;
            CKEDITOR.env.ie &&
              ((p = g.getDocumentElement().contains(this)),
              (g = g.getBody().contains(this)),
              (p = (f && g) || (!f && p)));
            p &&
              (CKEDITOR.env.webkit ||
              (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
                ? ((b = e.$.scrollLeft || l.scrollLeft),
                  (c = e.$.scrollTop || l.scrollTop))
                : ((c = f ? e.$ : l), (b = c.scrollLeft), (c = c.scrollTop)),
              (b = m.left + b - r),
              (c = m.top + c - u));
          } else
            for (
              u = this, r = null;
              u && "body" != u.getName() && "html" != u.getName();

            ) {
              b += u.$.offsetLeft - u.$.scrollLeft;
              c += u.$.offsetTop - u.$.scrollTop;
              u.equals(this) ||
                ((b += u.$.clientLeft || 0), (c += u.$.clientTop || 0));
              for (; r && !r.equals(u); )
                (b -= r.$.scrollLeft),
                  (c -= r.$.scrollTop),
                  (r = r.getParent());
              r = u;
              u = (m = u.$.offsetParent) ? new CKEDITOR.dom.element(m) : null;
            }
          a &&
            ((m = this.getWindow()),
            (u = a.getWindow()),
        ...
        scrollIntoParent: function (a, b, c) {
          ...
          function u(a, b) {
            ...
            c = a.getWindow();
            c.equals(b) ||
              ((c = u(CKEDITOR.dom.element.get(c.$.frameElement), b)),
              (g.x += c.x),
              (g.y += c.y));
            return g;
          }
          ...
          !a && (a = this.getWindow());
          f = a.getDocument();
          var p = "BackCompat" == f.$.compatMode;
          a instanceof CKEDITOR.dom.window &&
            (a = p ? f.getBody() : f.getDocumentElement());
          CKEDITOR.env.webkit &&
            (f = this.getEditor(!1)) &&
            (f._.previousScrollTop = null);
          f = a.getWindow();
          e = u(this, f);
          var z = u(a, f),
            B = this.$.offsetHeight;
          ...
          var t = a.$.clientHeight,
            y = a.$.clientWidth;
          f = e.x - r(this, "left") - z.x || 0;
          m = e.y - r(this, "top") - z.y || 0;
          g = e.x + g + r(this, "right") - (z.x + y) || 0;
          e = e.y + B + r(this, "bottom") - (z.y + t) || 0;
        ...
        copyAttributes: function (a, b) {
          ...
          for (var g = 0; g < c.length; g++) {
            var e = c[g],
              ...
              m;
            if (!(f in b))
              if ("checked" == f && (m = this.getAttribute(f)))
                a.setAttribute(f, m);
    ...
    (function () {
      function a(a, b) {
        ...
        if (!a && !this._.guardLTR) {
          var m = c.type == CKEDITOR.NODE_ELEMENT ? c : c.getParent(),
            l = c.type == CKEDITOR.NODE_ELEMENT ? c.getChild(k) : c.getNext();
        ...
        f = t
          ? function (a, b) {
              return !1 === G(a, b) ? !1 : t(a, b);
            }
          : G;
        this.current
          ? (c = this.current[n](!1, h, f))
          : (a
              ? c.type == CKEDITOR.NODE_ELEMENT &&
                (c =
                  0 < k
                    ...
                    : !1 === f(c, !0)
                    ? null
                    : c.getPreviousSourceNode(!0, h, f))
              : ((c = d),
                c.type == CKEDITOR.NODE_ELEMENT &&
                  ((c = c.getChild(e)) ||
                    (c =
                      !1 === f(d, !0) ? null : d.getNextSourceNode(!0, h, f)))),
            c && !1 === f(c) && (c = null));
        for (; c && !this._.end; ) {
          this.current = c;
      ...
      CKEDITOR.dom.walker.bookmark = function (a, b) {
        ...
        return function (c) {
          var d, e;
          d =
            c && c.type != CKEDITOR.NODE_ELEMENT && (e = c.getParent()) && g(e);
          d = a ? d : d || g(c);
          return !!(b ^ d);
        };
      };
    ...
    (function () {
      ...
      function f(a, b, c, d, e) {
        function k(a, b, g, c) {
          ...
          if (c && m) return d;
          t || c ? b.append(a.clone(!0, e), g) : (a.remove(), l && b.append(a));
          return d;
        }
        function f() {
          var a,
          ...
          for (a = 0; a < c; a++)
            if (((b = J[a]), (g = E[a]), !b.equals(g))) return a;
          return a - 1;
        }
        function h() {
          var b = S - 1,
          ...
          b < O - 1 || b < T - 1 || c
            ? (c
                ...
                : T == b + 1 && F
                ? a.moveToPosition(E[b], CKEDITOR.POSITION_BEFORE_END)
                : a.moveToPosition(E[b + 1], CKEDITOR.POSITION_BEFORE_START),
              d &&
                (b = J[b + 1]) &&
                b.type == CKEDITOR.NODE_ELEMENT &&
        ...
        var y = a.startContainer,
          ...
          H,
          K;
        if (t && D.type == CKEDITOR.NODE_TEXT && y.equals(D))
          (y = a.document.createText(y.substring(x, A))), c.append(y);
        else {
          ...
          for (
            ...
            ca = da.getNext();
            for (
              N != O || (da.equals(E[N]) && O < T)
                ? b && (V = M.append(da.clone(0, e)))
                : C
                ? k(da, M, !1, G)
                : H && M.append(a.document.createText(da.substring(x)));
              ca;
          ...
          M = c;
          for (N = S; N <= T; N++)
            if (((c = E[N]), (ca = c.getPrevious()), c.equals(J[N])))
              b && (M = M.getChild(0));
            else {
              N != T || (c.equals(J[N]) && T < O)
                ? b && (V = M.append(c.clone(0, e)))
                : F
                ? k(c, M, !1, I)
                : K && M.append(a.document.createText(c.substring(0, A)));
        ...
        return function (e) {
          return c(e) || b(e)
            ...
            : (e.type == CKEDITOR.NODE_TEXT &&
              ...
              (e.type == CKEDITOR.NODE_ELEMENT && !e.is(m))
            ? !1
            : !0;
        };
      }
      ...
      CKEDITOR.dom.range.prototype = {
        ...
        createBookmark2: (function () {
          function a(b) {
            ...
            e =
              ...
              k == e.getChildCount()
                ? 0
                : e.getChild(k - 1).type == CKEDITOR.NODE_TEXT &&
                  e.getChild(k).type == CKEDITOR.NODE_TEXT;
            e && ((g = g.getChild(d - 1)), (d = g.getLength()));
            if (g.type == CKEDITOR.NODE_ELEMENT && 0 < d) {
              a: {
                for (e = g; d--; )
                  if (((k = e.getChild(d).getIndex(!0)), 0 <= k)) {
                    d = k;
                    break a;
                  }
                d = -1;
            ...
            if (g.type == CKEDITOR.NODE_TEXT) {
              ...
              g.getText()
                ...
                : ((k = g.getPrevious(c)),
                  e
                    ? ((d = e),
                      (g = k ? k.getNext() : g.getParent().getFirst()))
                    : ((g = g.getParent()), (d = k ? k.getIndex(!0) + 1 : 0)));
            }
            b.container = g;
            b.offset = d;
          }
            ...
            if (d)
              if (d >= c.getLength())
                ...
                this.startContainer.equals(this.endContainer)
                  ? this.setEnd(k, this.endOffset - this.startOffset)
        ...
        enlarge: function (a, b) {
          ...
          switch (a) {
            ...
            case CKEDITOR.ENLARGE_ELEMENT:
              ...
              A.type == CKEDITOR.NODE_TEXT
                ? (F &&
                    ((A = !CKEDITOR.tools.trim(A.substring(0, F)).length && A),
                    (x = !!A)),
                  A && ((y = A.getPrevious()) || (t = A.getParent())))
                : (F && (y = A.getChild(F - 1) || A.getLast()), y || (t = A));
              for (t = c(t); t || y; ) {
                if (t && !y) {
                  !D && t.equals(f) && (D = !0);
                  if (e ? t.isBlockBoundary() : !h.contains(t)) break;
                  (x && "inline" == t.getComputedStyle("display")) ||
                    ((x = !1), D ? (m = t) : this.setStartBefore(t));
                  y = t.getPrevious();
                }
                for (; y; )
                  if (((A = !1), y.type == CKEDITOR.NODE_COMMENT))
                    ...
                    if (y.type == CKEDITOR.NODE_TEXT)
                      ...
                      if (x && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                        C = y.getText();
                        if (d.test(C)) y = null;
                        else
                          for (
                            var F = y.$.getElementsByTagName("*"), G = 0, I;
                            (I = F[G++]);
              ...
              D = x = !1;
              A.type == CKEDITOR.NODE_TEXT
                ? CKEDITOR.tools.trim(A.substring(F)).length
                  ? (x = !0)
                  : ((x = !A.getLength()),
                    F == A.getLength()
              ...
              for (; t || y; ) {
                if (t && !y) {
                  ...
                  if (e ? t.isBlockBoundary() : !h.contains(t)) break;
                  (x && "inline" == t.getComputedStyle("display")) ||
                    ((x = !1), D ? (l = t) : t && this.setEndAfter(t));
                  y = t.getNext();
                }
                for (; y; ) {
                  A = !1;
            ...
            case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
              ...
              var H,
                K,
                J = CKEDITOR.dom.walker.blockBoundary(
              ...
              this.setStartAt(
                H,
                !H.is("br") &&
                  ((!t && this.checkStartOfBlock()) || (t && H.contains(t)))
              ...
              t = new CKEDITOR.dom.walker(t);
              t.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? e : S;
              H = E = K = null;
              t = t.lastForward();
              H = H || h;
              this.setEndAt(
                H,
                (!t && this.checkEndOfBlock()) || (t && H.contains(t))
        ...
        splitBlock: function (a, b) {
          ...
          "br" != a &&
            (e ||
              ((e = this.fixBlock(!0, a)),
              (k = new CKEDITOR.dom.elementPath(this.endContainer, this.root)
                .block)),
            k || (k = this.fixBlock(!1, a)));
        ...
        _find: function (a, b) {
          ...
          if (c && c.find)
            for (f = c.find(a), k = 0; k < f.count(); k++)
              if (((c = f.getItem(k)), b || !c.isReadOnly()))
                (h =
    ...
    (function () {
      ...
      function b(a, c, d, e) {
        ...
        if (!e) return 0;
        if (
          (h = CKEDITOR.filter.instances[e.element.data("cke-filter")]) &&
          !h.check(c)
        )
          return b(a, c, d, e.remaining);
      ...
      a.prototype = {
        getNextParagraph: function (a) {
          ...
          if (!this._.started) {
            ...
            f = u.startPath();
            var r = u.endPath(),
              p = !u.collapsed && c(u, f.block),
              z = !u.collapsed && c(u, r.block, 1);
            u.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
            p && u.setStartAt(f.block, CKEDITOR.POSITION_BEFORE_END);
            z && u.setEndAt(r.block, CKEDITOR.POSITION_AFTER_START);
            f =
              u.endContainer.hasAscendant("pre", !0) ||
              u.startContainer.hasAscendant("pre", !0);
            u.enlarge(
              (this.forceBrBreak && !f) || !this.enlargeBr
                ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS
                : CKEDITOR.ENLARGE_BLOCK_CONTENTS
            );
            u.collapsed ||
              ((f = new CKEDITOR.dom.walker(u.clone())),
              (r = CKEDITOR.dom.walker.bookmark(!0, !0)),
              (f.evaluator = r),
              (this._.nextNode = f.next()),
              (f = new CKEDITOR.dom.walker(u.clone())),
              (f.evaluator = r),
              (f = f.previous()),
              (this._.lastNode = f.getNextSourceNode(!0, null, u.root)),
              this._.lastNode &&
                ...
                r.checkEndOfBlock() &&
                  ...
                  (this._.lastNode = (
                    r.block || r.blockLimit
                  ).getNextSourceNode(!0)))),
              (this._.lastNode && u.root.contains(this._.lastNode)) ||
                ((this._.lastNode = this._.docEndMarker =
                  u.document.createText("")),
                this._.lastNode.insertAfter(f)),
              (u = null));
            this._.started = 1;
            f = u;
          }
          ...
          for (this._.nextNode = null; r; ) {
            var p = 0,
              z = r.hasAscendant("pre"),
              B = r.type != CKEDITOR.NODE_ELEMENT,
              t = 0;
            if (B)
              r.type == CKEDITOR.NODE_TEXT && e.test(r.getText()) && (B = 0);
            else {
              var y = r.getName();
              if (
                ...
                r.isBlockBoundary(this.forceBrBreak && !z && { br: 1 })
              ) {
                if ("br" == y) B = 1;
                else if (!f && !r.getChildCount() && "hr" != y) {
                  g = r;
                  l = r.equals(u);
                  break;
                }
                f &&
                  (f.setEndAt(r, CKEDITOR.POSITION_BEFORE_START),
                  "br" != y && (this._.nextNode = r));
                p = 1;
              } else {
                if (r.getFirst()) {
                  f ||
                    ((f = this.range.clone()),
                    f.setStartAt(r, CKEDITOR.POSITION_BEFORE_START));
                  r = r.getFirst();
                  continue;
                }
                B = 1;
            ...
            B && f.setEndAt(r, CKEDITOR.POSITION_AFTER_END);
            r = this._getNextSourceNode(r, t, u);
            if ((l = !r) || (p && f)) break;
          }
          if (!g) {
            if (!f)
            ...
            !r.equals(f.root)
              ...
              ? (f.checkStartOfBlock() && f.checkEndOfBlock()) ||
                ...
                f.insertNode(g))
              : l ||
                (this._.nextNode = g.equals(u)
                  ? null
                  : this._getNextSourceNode(
                      f.getBoundaryNodes().endNode,
                      1,
                      u
                    ));
          }
          q &&
            ...
            ("br" == q.getName()
              ? q.remove()
              : q.getLast() &&
                "br" == q.getLast().$.nodeName.toLowerCase() &&
                q.getLast().remove());
          v &&
            (q = g.getLast()) &&
            q.type == CKEDITOR.NODE_ELEMENT &&
            "br" == q.getName() &&
            (!CKEDITOR.env.needsBrFiller || q.getPrevious(m) || q.getNext(m)) &&
            q.remove();
          this._.nextNode ||
            (this._.nextNode =
              l || g.equals(u) || !u ? null : this._getNextSourceNode(g, 1, u));
          return g;
        },
    ...
    (CKEDITOR.command = function (a, f) {
      ...
      this.refresh = function (a, b) {
        ...
        return !1 === this.fire("refresh", { editor: a, path: b })
          ? !0
          : f.refresh && !1 !== f.refresh.apply(this, arguments);
      };
      var b;
    ...
    (function () {
      function a(a, b, c, d, e) {
        ...
        for (g in b) {
          ...
          for (t in K) {
            ...
            for (E in r)
              "!" == E.charAt(0) &&
                ((E = E.slice(1)), n.push(E), (u[E] = !0), (D = !1));
            for (; (E = n.pop()); ) (r[E] = r["!" + E]), delete r["!" + E];
            m[y] = (D ? !1 : u) || null;
          }
        ...
        if (!a.match || a.match(c))
          if (g || d(a, c))
            if (
              ...
              e.allStyles ||
                (e.allStyles = b(a.styles, c.styles, e.validStyles)),
              !e.allClasses)
            ) {
              a = a.classes;
              c = c.classes;
              ...
              if (a)
                if (!0 === a) a = !0;
                  ...
                  for (var f = 0, k = c.length, h; f < k; ++f)
                    (h = c[f]), g[h] || (g[h] = a(h));
                  a = !1;
                }
              else a = !1;
      ...
      function g(a) {
        var b,
          ...
          g = {},
          f = 1;
        for (a = I(a); (b = a.match(E)); )
          (c = b[2])
            ? ((d = n(c, "styles")), (e = n(c, "attrs")), (c = n(c, "classes")))
            : (d = e = c = null),
            (g["$" + f++] = {
              elements: b[1],
              classes: c,
      ...
      function q(a, b, d, e) {
        ...
        if (e.doCallbacks && a.elementCallbacks) {
          a: {
            ...
            for (var h = 0, t = k.length, m; h < t; ++h)
              if ((m = k[h](b))) {
                k = m;
                break a;
              }
        ...
        if (e.doFilter) {
          a: {
            ...
            if (a || k) {
              ...
              if (t) for (p = 0, n = t.length; p < n; ++p) c(t[p], b, l);
              if (a) for (p = 0, n = a.length; p < n; ++p) f(a[p], b, l, m);
              if (k) for (p = 0, n = k.length; p < n; ++p) f(k[p], b, l, m);
              a = l;
            } else a = null;
          }
          ...
          if (!a.allAttributes)
            for (J in h)
              n[J] ||
                (z.test(J)
                  ? J == (v = J.replace(/^data-cke-saved-/, "")) ||
                    n[v] ||
                    (delete h[J], (p = !0))
                  : (delete h[J], (p = !0)));
          if (!a.allStyles || a.hadInvalidStyle) {
            for (J in E)
              a.allStyles || D[J] ? q.push(J + ":" + E[J]) : (p = !0);
            q.length && (h.style = q.sort().join("; "));
          } else x && (h.style = x);
          if (!a.allClasses || a.hadInvalidClass) {
            for (J = 0; J < t.length; ++J)
              (a.allClasses || k[t[J]]) && l.push(t[J]);
            l.length && (h["class"] = l.sort().join(" "));
            m && l.length < m.split(/\s+/).length && (p = !0);
          } else m && (h["class"] = m);
          p && (g = 1);
          if (!e.skipFinalValidation && !r(b)) return d.push(b), 1;
        }
      ...
      function t(a, b, c) {
        ...
        if (F.$empty[d] || !a.children.length)
          ...
          if ("br" == b)
            a.previous && !B(a.previous) && ((b = z()), b.insertBefore(a)),
              a.next && !B(a.next) && ((b = z()), b.insertAfter(a)),
            ...
            b: {
              e = F[b];
              for (var g = 0, k = d.length, f; g < k; ++g)
                if (
                  ((f = d[g]), f.type == CKEDITOR.NODE_ELEMENT && !e[f.name])
                ) {
                  e = !1;
                  break b;
                }
              ...
              for (
                ...
                (f = d[--k]),
                  ...
                  (f.type == CKEDITOR.NODE_TEXT ||
                    (f.type == CKEDITOR.NODE_ELEMENT && F.$inline[f.name]))
                    ? (h ||
      ...
      function D(a, b) {
        ...
        for (g in d)
          if ("class" == g)
            for (
              c = d[g].split(/\s+/), f = a.classes.join("|");
              (h = c.pop());
        ...
        if (a instanceof CKEDITOR.editor) {
          ...
          !0 === b
            ...
            : (b || (this.customConfig = !1),
              ...
              this.allow(
                H[a.enterMode] + " " + H[a.shiftEnterMode],
                "default",
                1
              ),
      ...
      CKEDITOR.filter.prototype = {
        ...
        applyTo: function (a, b, c, d) {
                ...
                a: {
                  ...
                  if (k)
                    for (l = 0; l < k.length; ++l)
                      if ((y = d.match(k[l])) && y[0].length == d.length) {
                        c = !0;
                        break a;
                      }
                  d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                  1 == d.children.length &&
                    (t = d.children[0]).type == CKEDITOR.NODE_ELEMENT &&
                    q(e, t, c, m);
                  c = !c.length;
                }
                c || g.push(a);
          ...
          for (; (l = a.pop()); )
            if (((c = l.el), c.parent))
              switch (((y = F[c.parent.name] || F.span), l.check)) {
                case "it":
            ...
            for (e = 0; e < a.length; ++e) {
              ...
              for (k = 0; k < b.length; ++k)
                (f = b[k]),
                  ...
                  t instanceof CKEDITOR.style && (t = A(t)),
                  c.push({
                    check: h == g ? null : h,
                    left: t,
                    right: "string" == typeof m ? C(m) : m,
                  });
              b = g;
              d[b] || (d[b] = []);
              d[b].push(c);
        ...
        check: function (a, b, c) {
          ...
          if ("string" == typeof a) {
            ...
            (d = a.getDefinition()),
              ...
              e && !CKEDITOR.tools.isEmpty(e)
                ? ((e = G(e)), (h.style = CKEDITOR.tools.writeCssText(e, !0)))
                : (e = {}),
              (e = {
                name: d.element,
                attributes: h,
          ...
          b =
            0 < t.length
              ? !1
              : CKEDITOR.tools.objectCompare(e.attributes, h.attributes, !0)
              ? !0
              : !1;
        ...
        transform: function (a, b) {
          if ("string" == typeof b) a.name = b;
            ...
            for (g in e)
              if ("class" == g)
                for (
                  c = a.classes.join("|"), k = e[g].split(/\s+/);
                  (h = k.pop());
    ...
    (function () {
      var a,
        f = function (b) {
          ...
          a ||
            (f && (a = !1 !== l.execCommand(f, { from: "keystrokeHandler" })),
                      ...
                      (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat)
                        ? (e.$.onreadystatechange = function () {
                            if (
                              ...
                              (e.$.onreadystatechange = null), w(b, !0);
                          })
                        : ((e.$.onload = function () {
                            setTimeout(function () {
                              w(b, !0);
    ...
    (CKEDITOR.resourceManager.prototype = {
      ...
      getFilePath: function (a) {
        ...
        return CKEDITOR.getUrl(
          this.getPath(a) + (f ? f.file : this.fileName + ".js")
        );
      },
        ...
        CKEDITOR.scriptLoader.load(
          ...
          function (a, e) {
            ...
            for (var g = 0; g < a.length; g++)
              for (var k = l[a[g]], h = 0; h < k.length; h++) {
                var m = k[h];
                d[m] = this.get(m);
                c[m] = 1;
              }
              ...
              a.call(
                ...
                function (a) {
                  ...
                  for (d in a) {
                    ...
                    if (!f[d]) {
                      if (n.icons)
                        for (var q = n.icons.split(","), v = q.length; v--; )
    ...
    (function () {
      ...
      function l(a) {
        ...
        c.fn
          ? (c.fn.call(a, a.config),
            (CKEDITOR.getUrl(a.config.customConfig) != b && l(a)) ||
        ...
        CKEDITOR.plugins.load(c.split(","), function (c) {
          ...
          for (var k in c) {
            ...
            t &&
              !a.lang[k] &&
              (t.split && (t = t.split(",")),
              0 <= CKEDITOR.tools.indexOf(t, a.langCode)
                ? (m = a.langCode)
                : ((m = a.langCode.replace(/-.*/, "")),
                  (m =
                    m != a.langCode && 0 <= CKEDITOR.tools.indexOf(t, m)
                      ? m
                      : 0 <= CKEDITOR.tools.indexOf(t, "en")
                      ? "en"
                      : t[0])),
              h.langEntries && h.langEntries[m]
                ? ((a.lang[k] = h.langEntries[m]), (m = null))
                : g.push(CKEDITOR.getUrl(h.path + "lang/" + m + ".js")));
            e.push(m);
            d.push(h);
          }
            ...
            for (
              ...
              for (var f = 0; f < d.length; f++) {
                ...
                0 === g &&
                  ...
                  k.lang &&
                  k.langEntries &&
                  (a.lang[k.name] = k.langEntries[e[f]]);
                if (k[c[g]]) k[c[g]](a);
              }
      ...
      CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
        ...
        getSelectedHtml: function (a) {
          ...
          for (
            var d = new CKEDITOR.dom.documentFragment(), e, g, f, k = 0;
            k < c.length;
            k++
          ) {
            var h = c[k],
              m = h.startContainer;
            m.getName && "tr" == m.getName()
              ? (e ||
                  ((e = m.getAscendant("table").clone()),
                  e.append(m.getAscendant("tbody").clone()),
                  d.append(e),
                  (e = e.findOne("tbody"))),
                (g && g.equals(m)) || ((g = m), (f = m.clone()), e.append(f)),
                f.append(h.cloneContents()))
      ...
      CKEDITOR.htmlParser.prototype = {
        ...
        parse: function (b) {
          for (var c, e, m = 0, l; (c = this._.htmlPartsRegex.exec(b)); ) {
            e = c.index;
            if (e > m)
              if (((m = b.substring(m, e)), l)) l.push(m);
              else this.onText(m);
    ...
    (function () {
      ...
      CKEDITOR.htmlParser.fragment.fromHtml = function (m, l, d) {
        function h(a) {
          ...
          if (0 < r.length)
            for (var c = 0; c < r.length; c++) {
              ...
              (f && !f[e]) || (a && g && !g[a] && CKEDITOR.dtd[a])
                ? e == z.name && (n(z, z.parent, 1), c--)
                : (b || (k(), (b = 1)),
                  (d = d.clone()),
                  (d.parent = z),
                  (z = d),
        ...
        function n(b, c, e) {
          ...
          var f = z;
          void 0 === b.previous &&
            (w(c, b) && ((z = c), v.onTagOpen(d, {}), (b.returnPoint = c = z)),
            g(b),
        ...
        var v = new CKEDITOR.htmlParser(),
          u =
            l instanceof CKEDITOR.htmlParser.element
              ? l
              : "string" == typeof l
              ? new CKEDITOR.htmlParser.element(l)
            ...
            if ("br" == d) p.push(e);
              ...
              for (
                ...
                !((m = (g = z.name)
                  ...
                  : c),
                e.isUnknown || z.isUnknown || m[d]);

              )
                if (z.isOptionalClose) v.onTagClose(g);
                else if (d in b && g in b)
                  (g = z.children),
                    ((g = g[g.length - 1]) && "li" == g.name) ||
                      n((g = new CKEDITOR.htmlParser.element("li")), z),
                    !e.returnPoint && (e.returnPoint = z),
                    (z = g);
                else if (d in CKEDITOR.dtd.$listItem && !q(d, g))
                  v.onTagOpen("li" == d ? "ul" : "dl", {}, 0, 1);
                else if (g in f && !q(d, g))
                  !e.returnPoint && (e.returnPoint = z), (z = z.parent);
                else if ((g in CKEDITOR.dtd.$inline && r.unshift(z), z.parent))
                  n(z, z.parent, 1);
                else {
                  e.isOrphan = 1;
                  break;
        ...
        v.onTagClose = function (a) {
          ...
          for (var c = [], e = [], g = z; g != u && g.name != a; )
            g._.isBlockLike || e.unshift(g),
              c.push(g),
        ...
        v.onText = function (a) {
          if (
            !((z._.hasInlineStarted && !p.length) || t || B) &&
          ...
          var b = z.name,
            g = b
              ? CKEDITOR.dtd[b] ||
                (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
              : c;
          if (!B && !g["#"] && b in f) v.onTagOpen(e[b] || ""), v.onText(a);
          else {
            k();
            h();
            t || B || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
            a = new CKEDITOR.htmlParser.text(a);
            if (w(z, a)) this.onTagOpen(d, {}, 0, 1);
            z.add(a);
          }
        };
    ...
    (function () {
      ...
      CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
        ...
        proto: {
          addRules: function (a, c) {
            ...
            "object" != typeof c && (c = {});
            a.elementNames &&
              this.elementNameRules.addMany(a.elementNames, e, c);
            a.attributeNames &&
          ...
          onNode: function (a, c) {
            var e = c.type;
            return e == CKEDITOR.NODE_ELEMENT
              ? this.onElement(a, c)
              : e == CKEDITOR.NODE_TEXT
              ? new CKEDITOR.htmlParser.text(this.onText(a, c.value))
              : e == CKEDITOR.NODE_COMMENT
      ...
      a.prototype = {
        ...
        addMany: function (a, c, e) {
          for (var f = [this.findIndex(c), 0], l = 0, d = a.length; l < d; l++)
            f.push({ value: a[l], priority: c, options: e });
          this.rules.splice.apply(this.rules, f);
        },
        findIndex: function (a) {
          for (
            var c = this.rules, e = c.length - 1;
            0 <= e && a < c[e].priority;
        ...
        execOnName: function (a, c) {
          for (var e = 0, f = this.rules, l = f.length, d; c && e < l; e++)
            (d = f[e]),
              (a.nonEditable && !d.options.applyToAll) ||
                (a.nestedEditable && d.options.excludeNestedEditable) ||
                (c = c.replace(d.value[0], d.value[1]));
          return c;
        },
      };
    })(),
    (function () {
          ...
          return function (e) {
            if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
              var f = [],
                ...
                l;
              if (h)
                for (k(h, 1) && f.push(h); h; )
                  m(h) &&
                    (t = c(h)) &&
                    k(t) &&
                    ((l = c(t)) && !m(l)
                      ? f.push(t)
                      : (g(y).insertAfter(t), t.remove())),
                    (h = h.previous);
              for (h = 0; h < f.length; h++) f[h].remove();
              if ((f = !a || !1 !== ("function" == typeof d ? d(e) : d)))
                y ||
                CKEDITOR.env.needsBrFiller ||
                e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
                  ? y ||
        ...
        function k(a, b) {
          ...
          return a.type == CKEDITOR.NODE_TEXT &&
            ...
            (c.index &&
              ...
              (a.value = c[0])),
            (!CKEDITOR.env.needsBrFiller && y && (!b || a.parent.name in n)) ||
              (!y && (((c = a.previous) && "br" == c.name) || !c || m(c))))
            ? !0
            : !1;
        }
        var h = { elements: {} },
          y = "html" == d,
          n = CKEDITOR.tools.extend({}, t),
          E;
      ...
      function m(a) {
        return (
          a &&
          ((a.type == CKEDITOR.NODE_ELEMENT && a.name in t) ||
        ...
        return a.replace(C, function (a, b, c) {
          return (
            ...
            c.replace(F, function (a, b) {
              return G.test(b) && -1 == c.indexOf("data-cke-saved-" + b)
      ...
      function g(a, b) {
        return a.replace(b, function (a, b, c) {
          0 === a.indexOf("\x3ctextarea") &&
            (a =
              b +
              q(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") +
              "\x3c/textarea\x3e");
          return (
            "\x3ccke:encoded\x3e" +
            encodeURIComponent(a) +
      ...
      function u(a, b) {
        ...
        return (a = a.replace(
          ...
          function (a, c, d, e) {
            return "\x3c" + c + d + "\x3e" + v(q(e), b) + "\x3c/" + c + "\x3e";
          }
        ));
      }
        ...
        b.on(
          ...
          function (a) {
            ...
            CKEDITOR.env.ie &&
              9 > CKEDITOR.env.version &&
              "pre" == d &&
              ((d = "div"), (c = "\x3cpre\x3e" + c + "\x3c/pre\x3e"), (e = 1));
            ...
            c = q(c);
            d =
              !1 === a.fixForBody ? !1 : f(a.enterMode, b.config.autoParagraph);
            c = CKEDITOR.htmlParser.fragment.fromHtml(c, a.context, d);
            d &&
              ((e = c),
              !e.children.length &&
                CKEDITOR.dtd[e.name][d] &&
                ((d = new CKEDITOR.htmlParser.element(d)), e.add(d)));
            a.dataValue = c;
          },
          null,
          null,
        ...
        b.on(
          ...
          function (a) {
            ...
            a.data.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(
              c,
              a.data.context,
              f(a.data.enterMode, b.config.autoParagraph)
            );
          },
          null,
          null,
      ...
      var r = /(?:&nbsp;|\xa0)$/,
        ...
        t = CKEDITOR.tools.extend({}, z.$blockLimit, z.$block),
        y = { elements: { input: d, textarea: d } },
        D = {
          attributeNames: [
            [/^on/, "data-cke-pa-on"],
            [/^data-cke-expando$/, ""],
          ...
          find: function (a, b) {
            ...
            for (l = 0; l < this.children.length; l++) {
              ...
              "function" == typeof a && a(d)
                ? f.push(d)
                : "string" == typeof a && d.name === a && f.push(d);
    ...
    (function () {
      ...
      CKEDITOR.template = function (m) {
        if (a[m]) this.output = a[m];
          ...
          this.output = a[m] = Function(
            "data",
            "buffer",
            "return buffer?buffer.push('" + l + "'):['" + l + "'].join('');"
          );
        }
      };
    })(),
    ...
    (function () {
      ...
      CKEDITOR.inlineAll = function () {
        ...
        for (b in CKEDITOR.dtd.$editable)
          for (
            var c = CKEDITOR.document.getElementsByTag(b), e = 0, m = c.count();
            e < m;
            e++
          )
            (a = c.getItem(e)),
              "true" == a.getAttribute("contenteditable") &&
                ((f = { element: a, config: {} }),
                !1 !== CKEDITOR.fire("inline", f) &&
                  CKEDITOR.inline(a, f.config));
      };
      CKEDITOR.domReady(function () {
    ...
    (function () {
      function a(a, e, m, l) {
        ...
        l == CKEDITOR.ELEMENT_MODE_REPLACE &&
          ...
          (d._.required = a.hasAttribute("required")),
          a.removeAttribute("required"));
        m && d.setData(m, null, !0);
        d.on("loaded", function () {
          b(d);
          l == CKEDITOR.ELEMENT_MODE_REPLACE &&
            d.config.autoUpdateElement &&
            a.$.form &&
            d._attachToForm();
      ...
      function b(a) {
        var b = a.name,
          f = a.element,
          l = a.elementMode,
          d = a.fire("uiSpace", { space: "top", html: "" }).html,
        ...
        l &&
          a.ui
            .space("contents")
            .setStyle("height", CKEDITOR.tools.cssLength(l));
      ...
      CKEDITOR.editor.prototype.setMode = function (a, b) {
        ...
        if (a != f.mode && l && l[a]) {
          ...
          if (f.mode) {
            ...
            "source" == f.mode &&
              l == h &&
              (f.fire("lockSnapshot", { forceUpdate: !0 }), (k = 1));
    ...
    (function () {
      function a(a) {
        ...
        if (
          ...
          if ((g = f(g, d))) g.appendBogus(), (h = CKEDITOR.env.ie);
        l(b, d.block, e) &&
          k.collapsed &&
          !k.getCommonAncestor().isReadOnly() &&
          ((d = k.clone()),
          ...
          insertElementIntoRange: function (a, b) {
            ...
            b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
              (b.startContainer.is({
                ...
                ? r(b)
                : b.startContainer.is(CKEDITOR.dtd.$list) && p(b));
            var f, k;
            if (g)
              for (
                ;
                (f = b.getCommonAncestor(0, 1)) &&
                (k = CKEDITOR.dtd[f.getName()]) &&
                (!k || !k[e]);

              )
                f.getName() in CKEDITOR.dtd.span
                  ? b.splitElement(f)
                  : b.checkStartOfBlock() && b.checkEndOfBlock()
                  ? (b.setStartBefore(f), b.collapse(!0), f.remove())
                  : b.splitBlock(
            ...
            if (!this.is("textarea")) {
                      ...
                      f[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                        ? (a.fire("saveSnapshot"),
                          f[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                            h.remove(),
                          f["moveToElementEdit" + (c ? "End" : "Start")](p),
                          f.select(),
                          a.fire("saveSnapshot"),
                          (d = 1))
                        : k.blockLimit &&
                          k.blockLimit.is("td") &&
                          (l = k.blockLimit.getAscendant("table")) &&
                          f.checkBoundaryOfElement(
                            l,
                            c ? CKEDITOR.START : CKEDITOR.END
                          ) &&
                          (p = l[c ? "getPrevious" : "getNext"](g))
                        ? (a.fire("saveSnapshot"),
                          f["moveToElementEdit" + (c ? "End" : "Start")](p),
                          f.checkStartOfBlock() && f.checkEndOfBlock()
                            ? p.remove()
              ...
              CKEDITOR.env.gecko &&
                this.attachListener(this, "mouseup", function (b) {
                  if (
                    2 == b.data.$.button &&
                    ((b = b.data.getTarget()), !b.getOuterHtml().replace(v, ""))
                  ) {
                    var c = a.createRange();
      ...
      u = (function () {
        ...
        function b(c, d) {
          ...
          -1 < v && (h[v].firstNotAllowed = 1);
          -1 < q && (h[q].lastNotAllowed = 1);
          return h;
        }
        function e(b, c) {
          var d = [],
        ...
        function k(b, c, d, e) {
          ...
          (f = new CKEDITOR.dom.walker(g).next()) &&
            ...
            e.contains(f) &&
            f.isIdentical(h) &&
            (f.moveChildren(h), f.remove(), k(b, c, d, e));
        }
        function h(b, c) {
          function d(b, c) {
            if (
        ...
        return function (n, E, v, q) {
          ...
          if (!q.checkReadOnly()) {
            var w =
              new CKEDITOR.dom.elementPath(q.startContainer, q.root)
                .blockLimit || q.root;
            n = {
              type: E,
              dontFilter: z,
            ...
            var B, I;
            "text" == n.type &&
              E.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) &&
              ((B = CKEDITOR.dom.element.createFromHtml(
                "\x3cspan\x3e\x26nbsp;\x3c/span\x3e",
                E.document
              )),
            ...
            for (u = B.startNode; (u = u.getParent()) && f(u); ) q.push(u);
            E.moveToBookmark(B);
            if ((B = v)) {
              B = n.range;
              if ("text" == n.type && n.inlineStylesRoot) {
                ...
                for (q = n.inlineStylesRoot.getParent(); !I.equals(q); )
                  (E = E.appendTo(I.clone())), (I = I.getParent());
            ...
            if (B) {
              ...
              var z = n.endPath.elements[0],
                ...
                w = z.getPosition(E),
                ga =
                  !!z.getCommonAncestor(E) &&
                  w != CKEDITOR.POSITION_IDENTICAL &&
                  !(
                    w &
              ...
              for (h(E, P); q < E.length; q++) {
                ...
                if ((L = w.isLineBreak)) {
                  ...
                  w.hasBlockSibling
                    ? (L = 1)
                    : (X = L.startContainer.getAscendant(m.$block, 1)) &&
                      X.is({ div: 1, p: 1 })
                    ? ((ba = X.getPosition(U)),
                      ba == CKEDITOR.POSITION_IDENTICAL ||
                      ba == CKEDITOR.POSITION_CONTAINS
                        ? (L = 0)
                        : ((U = L.splitElement(X)),
                          L.moveToPosition(U, CKEDITOR.POSITION_AFTER_START),
                          (L = 1)))
                    : (L = 0);
                }
                if (L) v = 0 < q;
                  ...
                  L = P.startPath();
                  !w.isBlock &&
                    l(n.editor, L.block, L.blockLimit) &&
                    (Y = d(n.editor)) &&
                    ((Y = B.createElement(Y)),
                    Y.appendBogus(),
                    P.insertNode(Y),
                    CKEDITOR.env.needsBrFiller &&
                      (R = Y.getBogus()) &&
                      R.remove(),
                    P.moveToPosition(Y, CKEDITOR.POSITION_BEFORE_END));
                  ...
                  if (u && w.isElement) {
                    L = P.startContainer;
                    for (U = null; L && !m[L.getName()][w.name]; ) {
                      if (L.equals(I)) {
                        L = null;
                        break;
                      }
                  ...
                  w.lastNotAllowed &&
                    q < E.length - 1 &&
                    ((Z = ga ? z : Z) &&
                      P.setEndAt(Z, CKEDITOR.POSITION_AFTER_START),
                    (u = 0));
                  P.collapse();
                }
              }
            ...
            for (aa = R.createBookmark(); (Q = n.zombies.pop()); )
              Q.getParent() &&
                ((Y = R.clone()),
        ...
        return {
          list: {
            detectMerge: function (a, b) {
              ...
              a.mergeList =
                f && k && f.getParent().equals(k.getParent()) && !f.equals(k);
              a.mergeListItems =
                e.block &&
                g.block &&
                e.block.is(CKEDITOR.dtd.$listItem) &&
                ...
                if (m || l)
                  m && l && b(m, l)
                    ? ((e.tableSurroundingRange = k),
                      k.setStartAt(m, CKEDITOR.POSITION_AFTER_END),
    ...
    (function () {
        ...
        if (c) {
          if (!1 !== b) {
            ...
            if (c.getLength() > f && g && g.intersectsNode(c.$)) {
              var k = [
                { node: e.anchorNode, offset: e.anchorOffset },
                { node: e.focusNode, offset: e.focusOffset },
              ];
          ...
          k &&
            ...
            (e = c.getSelection()),
            (c = c.createRange()),
            c.setStart(k[0].node, k[0].offset),
            c.collapse(!0),
            e.removeAllRanges(),
            e.addRange(c),
            e.extend(k[1].node, k[1].offset));
        }
      }
      function d(a, b) {
        return b
          ? a.replace(v, function (a, b) {
              return b ? " " : "";
            })
          : a.replace(q, "");
      }
      ...
      function g(a) {
        for (var b = 0; b < a.length; b++) {
          ...
          if (!c.collapsed) {
            ...
            d &&
              d.type == CKEDITOR.NODE_TEXT &&
              (g >= d.getLength() ? k.setStartAfter(d) : k.setStartBefore(d));
            e &&
              e.type == CKEDITOR.NODE_TEXT &&
              (f ? k.setEndAfter(e) : k.setEndBefore(e));
            ...
            d.evaluator = function (d) {
              if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
                ...
                d.getPosition(k.endContainer) & CKEDITOR.POSITION_CONTAINS ||
      ...
      var n = "function" != typeof window.getSelection,
        ...
        u,
        r,
        p = CKEDITOR.dom.walker.invisible(1),
        z = (function () {
          function a(b) {
            return function (a) {
        ...
        d.on("contentDom", function () {
          ...
          function c() {
            ...
            var a = CKEDITOR.document.$.selection,
              b = a.createRange();
            "None" != a.type &&
              b.parentElement().ownerDocument == e.$ &&
              b.select();
          }
          var e = d.document,
            g = CKEDITOR.document,
          ...
          h.attachListener(
            ...
            function () {
              r &&
                ...
                (r =
                  d._.previousActive &&
                  d._.previousActive.equals(e.getActive())) &&
                null != d._.previousScrollTop &&
                d._.previousScrollTop != h.$.scrollTop &&
                (h.$.scrollTop = d._.previousScrollTop);
              d.unlockSelection(r);
              r = 0;
            },
            null,
            ...
            h.attachListener(h, "mousedown", function (a) {
              2 == a.data.$.button &&
                (((a = d.document.getSelection()) &&
                  ...
                  (v = d.window.getScrollPosition()));
            });
            h.attachListener(h, "mouseup", function (a) {
              2 == a.data.$.button &&
                v &&
                ((d.document.$.documentElement.scrollLeft = v.x),
                (d.document.$.documentElement.scrollTop = v.y));
              v = null;
            });
                ...
                p.on("mousedown", function (a) {
                  function b(a) {
                    ...
                    if (q) {
                      ...
                      q.setEndPoint(
                        0 > u.compareEndPoints("StartToStart", c)
                          ? "EndToEnd"
                          : "StartToStart",
                        c
                      );
          ...
          if (t && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
            ...
            h.attachListener(
              CKEDITOR.env.ie ? h : e.getDocumentElement(),
              "mouseup",
              f,
              d
            );
        ...
        CKEDITOR.on("instanceReady", function (a) {
          ...
          b.on(
            ...
            function () {
              ...
              c &&
                (c.getCustomData("ready") ? l(a) : c.setCustomData("ready", 1));
            },
            null,
            null,
            -1
                ...
                var b = function (b, c) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      (n = k.compareEndPoints("StartToStart", b)),
                      0 < n)
                    )
                      l = m - 1;
                    else if (0 > n) h = m + 1;
                  ...
                  if (-1 == m || (m == e.length - 1 && 0 > n)) {
                    ...
                    for (d = e.length; 0 < k && 0 < d; )
                      (f = e[--d]),
                        f.nodeType == CKEDITOR.NODE_TEXT &&
                          ((p = f), (k -= f.nodeValue.length));
                    return { container: p, offset: -k };
                  }
                  k.collapse(0 < n ? !0 : !1);
                    ...
                    for (var d = [], e = 0; e < c.length; e++) {
                      for (
                        var g = c.item(e),
                          ...
                          k = 0,
                          a = new CKEDITOR.dom.range(this.root);
                        k < f.childNodes.length && f.childNodes[k] != g;
                        k++
                      );
                ...
                if (n) {
                  ...
                  if (
                    (f.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                      f.startContainer.getName() in b) ||
                    (f.endContainer.type == CKEDITOR.NODE_ELEMENT &&
                      f.endContainer.getName() in b)
                  )
                    f.shrink(CKEDITOR.NODE_ELEMENT, !0), (a = f.collapsed);
                  v = f.createBookmark();
                  b = v.startNode;
                  a || (g = v.endNode);
                  ...
                  g
                    ? ((k = f.document.$.body.createTextRange()),
                      k.moveToElementText(g.$),
                      v.setEndPoint("EndToEnd", k),
                      v.moveEnd("character", -1))
                    : ((p = b.getNext(h)),
                      (r = b.hasAscendant("pre")),
                      (p =
                        !(p && p.getText && p.getText().match(k)) &&
                        (r ||
                          !b.hasPrevious() ||
                      ...
                      r.setHtml("\x26#65279;"),
                      r.insertBefore(b),
                      p && f.document.createText("﻿").insertBefore(b));
                  f.setStartBefore(b);
                  b.remove();
                  a
                    ? (p
                        ...
                        : v.select(),
                      f.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START),
                      r.remove())
                    : (f.setEndBefore(g), g.remove(), v.select());
                } else {
                  g = this.getNative();
                  if (!g) return;
                  ...
                  for (v = 0; v < a.length; v++) {
                    if (
                      ...
                      (r = a[v + 1]),
                      (k = p.clone()),
                      k.setStart(p.endContainer, p.endOffset),
                      k.setEnd(r.startContainer, r.startOffset),
                      !k.collapsed &&
                        (k.shrink(CKEDITOR.NODE_ELEMENT, !0),
                        (f = k.getCommonAncestor()),
                        (k = k.getEnclosedNode()),
                        f.isReadOnly() || (k && k.isReadOnly())))
                    ) {
                    ...
                    try {
                      ...
                      if (0 <= E.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
                        f.collapse(1), r.setEnd(f.endContainer.$, f.endOffset);
                      else throw E;
                    }
                    g.addRange(r);
                  }
    ...
    (function () {
          ...
          for (
            ...
            if (t.equals(u)) (t = null), (l = !0);
              ...
              if (w && m && CKEDITOR.dtd.$block[B])
                for (
                  var D = t,
                    ...
                    C = x.length,
                    ea = 0,
                    D = C && new CKEDITOR.dom.range(D.getDocument());
                  ea < C;
                  ++ea
                ) {
                  var A = x[ea],
                  ...
                  if (ha ? ha.check(this) : 1)
                    D.selectNodeContents(A), b.call(this, D);
                }
              ...
              if (x)
                if (
                  ...
                  (ea = h),
                  !A ||
                    (!(A.getDtd() || CKEDITOR.dtd.span)[C] && !ea) ||
                    (x.parentRule && !x.parentRule(A)))
                )
                  l = !0;
                else {
                  if (
                    (z ||
                      (B &&
                        CKEDITOR.dtd.$removeEmpty[B] &&
                        (t.getPosition(u) | K) != K) ||
                      ((z = c.clone()), z.setStartBefore(t)),
                    (B = t.type),
                    B == CKEDITOR.NODE_TEXT ||
                      w ||
                      (B == CKEDITOR.NODE_ELEMENT && !t.getChildCount()))
                  ) {
                    for (
                      var B = t, H;
                      (l = !B.getNext(I)) &&
                      ((H = B.getParent()), n[H.getName()]) &&
                      f(H, q, k, J);
            ...
            if (l && z && !z.collapsed) {
              for (
                ...
                if (y.getName() == g) {
                  for (fa in k.attributes)
                    !C[fa] &&
                      (F = y.getAttribute(W)) &&
                      (l.getAttribute(fa) == F ? (x[fa] = 1) : (C[fa] = 1));
                  for (W in k.styles)
                    !A[W] &&
                      (F = y.getStyle(W)) &&
                      (l.getStyle(W) == F ? (B[W] = 1) : (A[W] = 1));
                }
                y = y.getParent();
              }
        ...
        function b() {
          for (
            var a = new CKEDITOR.dom.elementPath(d.getParent()),
              c = new CKEDITOR.dom.elementPath(l.getParent()),
              e = null,
              g = null,
              f = 0;
            f < a.elements.length;
          ...
          for (
            ...
            if (this.checkElementRemovable(k)) {
              ...
              (a.checkBoundaryOfElement(k, CKEDITOR.END) ||
                (h = a.checkBoundaryOfElement(k, CKEDITOR.START)))
                ? ((g = k), (g.match = h ? "start" : "end"))
                : (k.mergeSiblings(),
                  k.is(this.element)
                    ? q.call(this, k)
                    : u(k, t(this)[k.getName()]));
            }
          if (g) {
            k = d;
            for (f = 0; ; f++) {
      ...
      function q(a, b) {
        ...
        for (f in d)
          if (
            ...
            a.getAttribute(f) == y(f, d[f])
          )
            (b && "data-" == f.slice(0, 5)) ||
              ((g = a.hasAttribute(f)), a.removeAttribute(f));
        for (var k in c)
          (this._.definition.fullMatch && a.getStyle(k) != y(k, c[k], !0)) ||
            ((g = g || !!a.getStyle(k)), a.removeStyle(k));
        u(a, e, A[a.getName()]);
        g &&
      ...
      function v(a) {
        for (
          ...
          (d = c.getItem(e)), d.isReadOnly() || q.call(this, d, !0);
        for (var g in b)
          if (g != this.element)
            for (c = a.getElementsByTag(g), e = c.count() - 1; 0 <= e; e--)
              (d = c.getItem(e)), d.isReadOnly() || u(d, b[g]);
      }
      function u(a, b, c) {
        if ((b = b && b.attributes))
      ...
      function B(a, b) {
        for (var c in a)
          a[c] = a[c].replace(G, function (a, c) {
            return b[c];
          });
      }
      function t(a) {
      ...
      function x(a, b, c) {
        ...
        for (var g, f = e.createIterator(); (g = f.getNextRange()); )
          b.call(this, g, c);
        a.selectRanges(e);
      ...
      CKEDITOR.style = function (a, b) {
        ...
        c &&
          ...
          delete c.style);
        b &&
          ((a = CKEDITOR.tools.clone(a)), B(a.attributes, b), B(a.styles, b));
        ...
        b ||
          ...
          this.on("selectionChange", function (a) {
            for (var e = 0; e < b.length; e++) {
              var f = b[e],
                l = f.style.checkActive(a.data.path, this)
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
      ...
      split: function (a) {
        ...
        f.childNodes.length == b &&
          (a >= c
            ? ((m = e.createText("")), m.insertAfter(this))
            : ((a = e.createText("")), a.insertAfter(m), a.remove()));
        return m;
      },
      substring: function (a, f) {
        return "number" != typeof f
          ? this.$.nodeValue.substr(a)
          : this.$.nodeValue.substring(a, f);
      },
    }),
    (function () {
      function a(a, c, e) {
        ...
        l.equals(h.getPrevious())
          ? ((c.startOffset =
              c.startOffset - l.getLength() - a.getPrevious().getLength()),
            (l = a.getNext()))
          : l.equals(a.getPrevious()) &&
            ((c.startOffset -= l.getLength()), (l = a.getNext()));
      ...
      var f = {
          ...
          return {
            getNextRange: function (l) {
              ...
              if (d && 1 < a.length) {
                ...
                for (d.moveToBookmark(e.shift()); k--; )
                  (h = a[++f]),
        ...
        createBookmarks: function (b) {
          for (var c = [], e, f = 0; f < this.length; f++) {
            ...
            for (var l = f + 1; l < this.length; l++)
              (this[l] = a(e, this[l])), (this[l] = a(e, this[l], !0));
          }
          return c;
        },
        createBookmarks2: function (a) {
        ...
        setUiColor: function (a) {
          ...
          return (this.setUiColor = function (a) {
            ...
            var c = CKEDITOR.skin.chameleon,
              ...
              k = "";
            "function" == typeof c &&
              ((f = c(this, "editor")), (k = c(this, "panel")));
            a = [[h, a]];
            e([b], f, a);
            e(d, k, a);
          }).call(this, a);
    ...
    (function () {
      ...
      if ((a = CKEDITOR._.pending))
        for (delete CKEDITOR._.pending, f = 0; f < a.length; f++)
    ...
    (CKEDITOR.skin.chameleon = (function () {
      var a = (function () {
          return function (a, c) {
            for (var e = a.match(/[^#]./g), f = 0; 3 > f; f++) {
              ...
              d = (
                "0" +
                (0 > c ? 0 | (d * (1 + c)) : 0 | (d + (255 - d) * c)).toString(
                  16
                )
              ).slice(-2);
              e[l] = d;
      ...
      return function (b, c) {
        var e = a(b.uiColor, 0.4),
          e = {
            id: "." + b.id,
            defaultBorder: a(e, -0.2),
            toolbarElementsBorder: a(e, -0.25),
            defaultBackground: e,
            lightBackground: a(e, 0.8),
            darkBackground: a(e, -0.15),
            ckeButtonOn: a(e, 0.4),
            ckeResizer: a(e, -0.4),
            ckeColorauto: a(e, 0.8),
            dialogBody: a(e, 0.7),
            dialogTab: a(e, 0.65),
            dialogTabSelected: "#FFF",
            dialogTabSelectedBorder: "#FFF",
            elementsPathColor: a(e, -0.6),
            menubuttonHover: a(e, 0.1),
            menubuttonIcon: a(e, 0.5),
            menubuttonIconHover: a(e, 0.3),
          };
                  ...
                  function () {
                    for (
                      ...
                      var p = c.items[m],
                        ...
                        z = CKEDITOR.tools.extend({}, t, { title: z }, !0),
                        D = {
                          type: "radio",
              ...
              if (!(3 > arguments.length)) {
                ...
                CKEDITOR.ui.dialog.labeledElement.call(
                  ...
                  function () {
                    ...
                    for (
                      var m = 0, p;
                      m < c.items.length && (p = c.items[m]);
                      m++
                    )
                      f.push(
                        '\x3coption value\x3d"',
                        CKEDITOR.tools
                          .htmlEncode(void 0 !== p[1] ? p[1] : p[0])
                          .replace(/"/g, "\x26quot;"),
                        '" /\x3e ',
                        CKEDITOR.tools.htmlEncode(p[0])
                      );
                    "undefined" != typeof a.inputStyle &&
                      (a.style = a.inputStyle);
              ...
              return function (d, e, f) {
                if (!(3 > arguments.length)) {
                  ...
                  if (r) {
                    var p = this.focus;
                    this.focus = function () {
                      ("function" == typeof r ? r : p).call(this);
                      this.fire("focus");
                    };
            ...
            eventProcessors: {
              onChange: function (a, b) {
                if (!CKEDITOR.env.ie || 8 < CKEDITOR.env.version)
                  return e.onChange.apply(this, arguments);
                a.on(
                  "load",
                  function () {
        ...
        CKEDITOR.dialog.addUIElement("fieldset", {
          build: function (a, b, c) {
            for (
              ...
              f.push(r);
              l.push(
                CKEDITOR.dialog._.uiElementBuilders[e.type].build(a, e, r)
              );
            }
    ...
    (function () {
      ...
      function m(a) {
        var b = CKEDITOR.dom.element.createFromHtml(
            CKEDITOR.addTemplate("dialog", u).output({
      ...
      function k(a) {
        function b(c) {
          ...
          a.move(
            e.x + h[3] < g
              ? -h[3]
              : e.x - h[1] > l.width - k.width - g
              ? l.width - k.width + ("rtl" == f.lang.dir ? 0 : h[1])
              : e.x,
            e.y + h[0] < g
              ? -h[0]
              : e.y - h[2] > l.height - k.height - g
      ...
      function g(a) {
        function b(c) {
          ...
          if (
            ...
            p = Math.max(d.minWidth || 0, v - g);
          if (
            e == CKEDITOR.DIALOG_RESIZE_HEIGHT ||
            e == CKEDITOR.DIALOG_RESIZE_BOTH
          )
            r = Math.max(d.minHeight || 0, t - h);
          a.resize(p, r);
          a._.moved || a.layout();
          c.data.preventDefault();
        }
          ...
          var f = a.getParentEditor(),
            ...
            p = CKEDITOR.tools.addFunction(function (d) {
              ...
              CKEDITOR.env.ie6Compat &&
                ((e = x.getChild(0).getFrameDocument()),
                e.on("mousemove", b),
                e.on("mouseup", c));
      ...
      CKEDITOR.dialog = function (b, d) {
        ...
        function n(c) {
          if (x == CKEDITOR.dialog._.currentTop) {
            ...
            if (9 == d || d == CKEDITOR.SHIFT + 9)
              ...
              (d =
                -1 != CKEDITOR.tools.indexOf([e ? 39 : 37, 38], d)
                  ? a.call(x)
                  : f.call(x)),
                x.selectPage(d),
                x._.tabs[d][0].focus(),
        ...
        CKEDITOR.event.call(this);
        this.definition = v = CKEDITOR.fire(
          "dialogDefinition",
          { name: d, definition: v },
          b
        ).definition;
          ...
          function () {
            ...
            b.config.dialog_startupFocusTab && a
              ...
              : this._.hasFocus ||
                ...
                v.onFocus ? (a = v.onFocus.call(this)) && a.focus() : l(1));
          },
          this,
          null,
          4294967295
        ...
        k(this);
        g(this);
        new CKEDITOR.dom.text(v.title, CKEDITOR.document).appendTo(
          this.parts.title
        );
        for (u = 0; u < v.contents.length; u++)
          (B = v.contents[u]) && this.addPage(B);
        this.parts.tabs.on(
          "click",
          function (a) {
            var b = a.data.getTarget();
      ...
      CKEDITOR.dialog.prototype = {
          ...
          for (var c in b.contents)
            if (b.contents[c]) {
              ...
              if (e) {
                ...
                !g || (f && !this._.editor.activeFilter.check(f))
        ...
        addPage: function (a) {
          if (
            ...
            a.accessKey &&
              (G(this, this, "CTRL+" + a.accessKey, K, H),
      ...
      var r = {
        ...
        p = function (a, b, c) {
          for (var d = 0, e; (e = a[d]); d++)
            if (e.id == b || (c && e[c] && (e = p(e[c], b, c)))) return e;
          return null;
        },
              ...
              CKEDITOR.ui.dialog.uiElement.call(
                ...
                function () {
                  ...
                  for (k = 0; k < c.length; k++) {
                    ...
                    g
                      ? g[k] && d.push("width:" + v(g[k]))
                      : d.push("width:" + Math.floor(100 / c.length) + "%");
                    h && d.push("height:" + v(h));
                    e &&
                      void 0 !== e.padding &&
                      d.push("padding:" + v(e.padding));
                    CKEDITOR.env.ie &&
                      CKEDITOR.env.quirks &&
                      f[k].align &&
                      d.push("text-align:" + f[k].align);
      ...
      CKEDITOR.plugins.add("a11yhelp", {
        ...
        init: function (a) {
          ...
          a.addCommand("a11yHelp", {
            exec: function () {
              var b = a.langCode,
                b = f.availableLangs[b]
                  ? b
                  : f.availableLangs[b.replace(/-.*/, "")]
                  ? b.replace(/-.*/, "")
                  : "en";
              CKEDITOR.scriptLoader.load(
                CKEDITOR.getUrl(f.path + "dialogs/lang/" + b + ".js"),
                function () {
    ...
    (function () {
          ...
          if (e) {
            ...
            if (b == CKEDITOR.TRISTATE_OFF) {
              ...
              for (d = 0; d < l.length; d++)
                (b = l[d]), (h = h.getCommonAncestor(b.getParent()));
              for (
              ...
              for (d = null; 0 < l.length; ) {
                for (b = l.shift(); !b.getParent().equals(h); )
                  b = b.getParent();
                b.equals(d) || e.push(b);
                d = b;
              }
              for (; 0 < e.length; )
                if (((b = e.shift()), "blockquote" == b.getName())) {
                  for (
                    ...
                    d.append(b.getFirst().remove()), l.push(d.getLast());
                  d.replace(b);
                } else l.push(b);
              e = a.document.createElement("blockquote");
              for (e.insertBefore(l[0]); 0 < l.length; )
                (b = l.shift()), e.append(b);
              ...
              for (h = {}; (b = k.getNextParagraph()); ) {
                ...
                e &&
                  l &&
                  !l.getCustomData("blockquote_moveout") &&
                  (d.push(l),
              ...
              for (h = {}; 0 < d.length; )
                (k = d.shift()),
                  ...
                  k.getPrevious()
                    ? k.getNext()
                      ? (k.breakParent(k.getParent()), l.push(k.getNext()))
                      : k.remove().insertAfter(e)
                    : k.remove().insertBefore(e),
                  e.getCustomData("blockquote_processed") ||
                    (l.push(e),
                    CKEDITOR.dom.element.setMarker(
                      h,
                      e,
              ...
              for (d = l.length - 1; 0 <= d; d--) {
                ...
                a: {
                  h = e;
                  for (
                    var k = 0, g = h.getChildCount(), n = void 0;
                    k < g && (n = h.getChild(k));
                    k++
                  )
                    if (
              ...
              if (a.config.enterMode == CKEDITOR.ENTER_BR)
                for (e = !0; b.length; )
                  if (((k = b.shift()), "div" == k.getName())) {
                    ...
                    !e ||
                      !k.getPrevious() ||
                      (k.getPrevious().type == CKEDITOR.NODE_ELEMENT &&
                    ...
                    for (
                      e =
                        ...
                        !(
                          ...
                          k.getNext().isBlockBoundary()
                        );
                      k.getFirst();

                    )
                      k.getFirst().remove().appendTo(d);
      ...
      CKEDITOR.plugins.add("blockquote", {
        init: function (f) {
          f.blockless ||
            (f.addCommand("blockquote", a),
            f.ui.addButton &&
              f.ui.addButton("Blockquote", {
    ...
    (function () {
      ...
      function f(b) {
        ...
        function m(a, c) {
          ...
          if (!d.getById("cke_pastebin")) {
            ...
            var p = new CKEDITOR.dom.element(
            ...
            CKEDITOR.env.webkit
              ? (e.append(p),
                ...
                e.is("body") ||
                  ...
                  (n = n.getDocumentPosition().y)))
              : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(p);
            p.setStyles({
              position: "absolute",
            ...
            (n = p.getParent().isReadOnly())
              ? (p.setOpacity(0), p.setAttribute("contenteditable", !0))
              : p.setStyle(
        ...
        function y(c) {
          ...
          e && A.canClipboardApiBeTrusted(d.dataTransfer, b)
            ? (c.data.preventDefault(),
              setTimeout(function () {
                a(b, d);
              }, 0))
        ...
        b.getClipboardData = function (a, c) {
          ...
          !1 === B() &&
            ...
            h && b.fire("pasteDialog", f)
              ? (b.on("pasteDialogCommit", e),
      ...
      CKEDITOR.plugins.clipboard = {
        ...
        fixSplitNodesAfterDrop: function (a, b, c, d) {
          ...
          "number" == typeof d &&
            "number" == typeof c &&
            f.type == CKEDITOR.NODE_ELEMENT &&
            (e(a.startContainer, f, c) || e(a.endContainer, f, d));
        },
      ...
      var k = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported
        ? "cke/id"
        : "Text";
      CKEDITOR.plugins.clipboard.dataTransfer = function (a, b) {
        ...
        this.id ||
          (this.id = "Text" == k ? "" : "cke-" + CKEDITOR.tools.getUniqueId());
        if ("Text" != k)
          try {
        ...
        proto: {
          ...
          onKeyDown: function (a, b) {
            ...
            switch (f) {
              case "next":
                for (
                  var l = this._.focusIndex,
                    f = this.element.getElementsByTag("a"),
                    d;
                  (d = f.getItem(++l));
              ...
              case "prev":
                ...
                return d || b
                  ? !1
                  : ((this._.focusIndex = f.count()), this.onKeyDown(a, 1));
              case "click":
              case "mouseup":
                return (
                  (l = this._.focusIndex),
                  (d =
                    0 <= l && this.element.getElementsByTag("a").getItem(l)) &&
                    (d.$[f] ? d.$[f]() : d.$["on" + f]()),
                  !1
                );
            }
    ...
    (function () {
      function a(a, c, e, m, l) {
        ...
        var d = f[l];
        d ||
          ((d = f[l] = new CKEDITOR.ui.panel(c, m)),
          (d.element = e.append(
            CKEDITOR.dom.element.createFromHtml(d.render(a), c)
          )),
        ...
        proto: {
          ...
          showBlock: function (a, c, e, f, l, d) {
            ...
            var n = this.element,
              ...
              w = q ? q.getDocumentPosition(w) : { x: 0, y: 0 },
              u = "rtl" == this._.dir,
              r = v.x + (f || 0) - w.x,
              p = v.y + (l || 0) - w.y;
            !u || (1 != e && 4 != e)
              ? u || (2 != e && 3 != e) || (r += c.$.offsetWidth - 1)
              : (r += c.$.offsetWidth);
            if (3 == e || 4 == e) p += c.$.offsetHeight - 1;
            this._.panel._.offsetParentId = c.getId();
            n.setStyles({ top: p + "px", left: 0, display: "" });
            n.setOpacity(0);
                ...
                var a = CKEDITOR.tools.bind(function () {
                  ...
                  CKEDITOR.env.ie &&
                    ...
                    "rtl" == b.getComputedStyle("direction") &&
                      (r = CKEDITOR.env.ie8Compat
                        ? r -
                          2 * n.getDocument().getDocumentElement().$.scrollLeft
                        : r - (a.$.scrollWidth - a.$.clientWidth)));
                  var a = n.getFirst(),
                    l;
                  (l = a.getCustomData("activePanel")) &&
                    l.onHide &&
                    l.onHide.call(this, 1);
                  a.setCustomData("activePanel", this);
                  n.setStyles({ top: p + "px", left: r + "px" });
                  n.setOpacity(1);
                  d && d();
                }, this);
          ...
          showAsChild: function (a, c, e, f, l, d) {
            if (
              ...
              a._.panel._.offsetParentId != e.getId()
            )
              this.hideChild(),
    ...
    CKEDITOR.plugins.add("menu", {
      ...
      beforeInit: function (a) {
        for (
          var f = a.config.menu_groups.split(","),
            b = (a._.menuGroups = {}),
            c = (a._.menuItems = {}),
            e = 0;
          e < f.length;
    ...
    (function () {
      ...
      CKEDITOR.env.gecko &&
        CKEDITOR.env.mac &&
        (f += ' onkeypress\x3d"return false;"');
      CKEDITOR.env.gecko &&
        (f += ' onblur\x3d"this.style.cssText \x3d this.style.cssText;"');
      var f =
          f +
            ...
            for (var f = 0; f < e.length; f++) {
              ...
              if (g)
                for (var n in g) {
                  ...
                  !w ||
                    (w.command && !this.editor.getCommand(w.command).state) ||
                    ((w.state = g[n]), this.add(w));
                }
            }
          },
          onClick: function (a) {
        ...
        proto: {
          ...
          show: function (b, c, d, e) {
            ...
            if (!n) {
              ...
              q["rtl" == g.lang.dir ? 37 : 39] = CKEDITOR.env.ie
                ? "mouseup"
                : "click";
            ...
            CKEDITOR.ui.fire("ready", this);
            this.parent
              ? this.parent._.panel.showAsChild(n, this.id, b, c, d, e)
              : n.showBlock(this.id, b, c, d, e);
            g.fire("menuShow", [n]);
          },
        ...
        proto: {
          render: function (a, f, d) {
            ...
            this.role in { menuitemcheckbox: 1, menuitemradio: 1 } &&
              (g =
                ' aria-checked\x3d"' +
                (k == CKEDITOR.TRISTATE_ON ? "true" : "false") +
                '"');
            var u = this.getItems,
              r =
                "\x26#" +
            ...
            this.command &&
              ((w = n.getCommand(this.command)),
              (w = n.getCommandKeystroke(w)) &&
                (q = CKEDITOR.tools.keystrokeToString(
            ...
            a = {
              ...
              ariaShortcut: q
                ? n.lang.common.keyboardShortcut + " " + q.aria
                : "",
              href:
              ...
              shortcutHtml: q ? e.output({ shortcut: q.display }) : "",
              arrowHtml: u ? c.output({ label: r }) : "",
                ...
                function (a) {
                  ...
                  if (!f || !c) {
                    ...
                    if (CKEDITOR.env.mac && CKEDITOR.env.webkit) {
                      var c = this.editor,
                        l = new CKEDITOR.dom.elementPath(
                          a.getTarget(),
                          c.editable()
                        ).contains(function (a) {
      ...
      function a(a, b) {
        ...
        var w = CKEDITOR.tools.addFunction(l),
          q = CKEDITOR.tools.addFunction(function (b, c) {
            ...
            switch (c.getKeystroke()) {
              ...
              case 9:
                return (
                  (f = CKEDITOR.document.getById(d + (b + 1))) ||
              ...
              case CKEDITOR.SHIFT + 9:
                return (
                  (f = CKEDITOR.document.getById(d + (b - 1))) ||
                    (f = CKEDITOR.document.getById(d + (g.list.length - 1))),
                  f.focus(),
                  !1
                );
              case 27:
        ...
        a.on("selectionChange", function () {
          for (
            ...
            var D = B[y],
              x = 0;
            t = D.data("cke-display-name")
              ? D.data("cke-display-name")
              : D.data("cke-real-element-type")
              ? D.data("cke-real-element-type")
              : D.getName();
            (m = D.hasAttribute("contenteditable")
              ? "true" == D.getAttribute("contenteditable")
              : m) ||
            ...
            x || (d.unshift(D), f.unshift(t));
          }
          d = d.length;
          for (l = 0; l < d; l++)
            (t = f[l]),
              (m = a.lang.elementspath.eleTitle.replace(/%1/, t)),
              (t = c.output({
                id: n + l,
                label: m,
                text: t,
          ...
          b.on("dirChanged", function (a) {
            ...
            for (var f = new CKEDITOR.dom.walker(e), k; (k = f.next()); )
              if (k.type == CKEDITOR.NODE_ELEMENT)
                if (!k.equals(d) && k.getDirection())
                  e.setStartAfter(k), (f = new CKEDITOR.dom.walker(e));
                else {
                  ...
                  if (g)
                    for (
                      ...
                      k.hasClass(g[w] + n[0]) &&
                        (k.removeClass(g[w] + n[0]), k.addClass(g[w] + n[1]));
                  g = k.getStyle("margin-right");
                  n = k.getStyle("margin-left");
                  g
                    ? k.setStyle("margin-left", g)
                    : k.removeStyle("margin-left");
                  n
                    ? k.setStyle("margin-right", n)
                    : k.removeStyle("margin-right");
                }
          });
        },
      });
                  ...
                  c.on(
                    ...
                    c.on(
                      ...
                      function (c) {
                        ...
                        c.data.states[b.name + "@" + e] = b.refreshJob(
                          a,
                          e,
                          c.data.path
                        );
      ...
      CKEDITOR.plugins.indent.specificDefinition.prototype = {
        ...
        refreshJob: function (a, b, m) {
          ...
          a.activeFilter.checkFeature(this)
            ? (b.state = b.refresh.call(this, a, m))
            : (b.state = f);
          return b.state;
        },
    ...
    (function () {
      function a(a) {
        function c(f) {
          for (
            var h = q.startContainer, m = q.endContainer;
            h && !h.getParent().equals(f);
          ...
          if (!h || !m) return !1;
          for (var v = h, h = [], u = !1; !u; )
            v.equals(m) && (u = !0), h.push(v), (v = v.getNext());
          ...
          for (
            var v = e.isIndent ? 1 : -1,
              m = h[0],
              h = h[h.length - 1],
              u = CKEDITOR.plugins.list.listToArray(f, g),
              y = u[h.getCustomData("listarray_index")].indent,
            ...
            if (((u[m].indent += v), 0 < v)) {
              var w = u[m].parent;
              u[m].parent = new CKEDITOR.dom.element(
                w.getName(),
                w.getDocument()
              );
            }
          ...
          if (!e.isIndent) {
            ...
            if ((x = f.getParent()) && x.is("li"))
              for (
                var v = h.listNode.getChildren(), A = [], C, m = v.count() - 1;
                0 <= m;
                m--
              )
                (C = v.getItem(m)) && C.is && C.is("li") && A.push(C);
          }
          ...
          if (A && A.length)
            for (m = 0; m < A.length; m++) {
              for (
                C = f = A[m];
                (C = C.getNext()) && C.is && C.getName() in l;

              )
                CKEDITOR.env.needsNbspFiller &&
                  !f.getFirst(b) &&
                  f.append(q.document.createText(" ")),
                  f.append(C);
              f.insertAfter(x);
            }
        ...
        for (
          ...
          for (
            var v = q.getCommonAncestor();
            v && (v.type != CKEDITOR.NODE_ELEMENT || !l[v.getName()]);
          ...
          v ||
            ((v = q.startPath().contains(l)) &&
              q.setEndAt(v, CKEDITOR.POSITION_BEFORE_END));
          if (!v) {
            var u = q.getEnclosedNode();
            u &&
              u.type == CKEDITOR.NODE_ELEMENT &&
              u.getName() in l &&
              (q.setStartAt(u, CKEDITOR.POSITION_AFTER_START),
              q.setEndAt(u, CKEDITOR.POSITION_BEFORE_END),
              (v = u));
          }
          v &&
            q.startContainer.type == CKEDITOR.NODE_ELEMENT &&
            q.startContainer.getName() in l &&
            ((u = new CKEDITOR.dom.walker(q)),
            (u.evaluator = f),
            (q.startContainer = u.next()));
          v &&
            q.endContainer.type == CKEDITOR.NODE_ELEMENT &&
            q.endContainer.getName() in l &&
            ((u = new CKEDITOR.dom.walker(q)),
            (u.evaluator = f),
            (q.endContainer = u.previous()));
          if (v) return c(v);
        }
        return 0;
      }
    ...
    (function () {
      function a(a, b, c) {
        ...
        for (
          var e = CKEDITOR.plugins.list.listToArray(b.root, c), f = [], g = 0;
          g < b.contents.length;
          g++
        ) {
          var h = b.contents[g];
      ...
      function b(a, b, c, d) {
        for (var e, f; (e = a[d ? "getLast" : "getFirst"](q)); )
          (f = e.getDirection(1)) !== b.getDirection(1) &&
      ...
      function m(a, d, e) {
        ...
        m
          ? (m = m.getBogus()) && m.remove()
          : q && (m = q.getPrevious(g)) && n(m) && m.remove();
        (m = f.getLast()) &&
        ...
        (m = d.startContainer.getChild(d.startOffset))
          ? f.insertBefore(m)
          : d.startContainer.append(f);
        w &&
          (f = l(w)) &&
          (k.contains(w) ? (b(f, w.getParent(), w), f.remove()) : k.append(f));
        for (; e.checkStartOfBlock() && e.checkEndOfBlock(); ) {
          ...
          f.is("li") &&
            ((k = f.getParent()),
            f.equals(k.getLast(g)) && f.equals(k.getFirst(g)) && (f = k));
      ...
      CKEDITOR.plugins.list = {
        listToArray: function (a, b, c, e, f) {
          ...
          for (var g = 0, h = a.getChildCount(); g < h; g++) {
            ...
            k.type == CKEDITOR.NODE_ELEMENT &&
              ...
              CKEDITOR.plugins.list.listToArray(k, b, c, e + 1);
            if ("li" == k.$.nodeName.toLowerCase()) {
              ...
              c.push(l);
              for (var m = 0, n = k.getChildCount(), q; m < n; m++)
                (q = k.getChild(m)),
                  q.type == CKEDITOR.NODE_ELEMENT && d[q.getName()]
        ...
        arrayToList: function (a, b, c, e, f) {
          ...
          for (
            var h,
              l = a[c].parent.getDocument(),
              m = new CKEDITOR.dom.documentFragment(l),
              n = null,
              q = c,
              w = Math.max(a[c].indent, 0),
              C = null,
              F,
              G,
              I = e == CKEDITOR.ENTER_P ? "p" : "div";
            ;
            ...
            if (H.indent == w) {
              (n && a[q].parent.getName() == n.getName()) ||
                ((n = a[q].parent.clone(!1, 1)),
                f && n.setAttribute("dir", f),
                m.append(n));
              C = n.append(H.element.clone(0, 1));
              F != n.getDirection(1) && C.setAttribute("dir", F);
              for (h = 0; h < H.contents.length; h++)
                C.append(H.contents[h].clone(1, 1));
              q++;
            } else if (H.indent == Math.max(w, 0) + 1)
              (H = a[q - 1].element.getDirection(1)),
                (q = CKEDITOR.plugins.list.arrayToList(
                  a,
                  null,
                  q,
                  e,
                ...
                !C.getChildCount() &&
                  CKEDITOR.env.needsNbspFiller &&
                  7 >= l.$.documentMode &&
                  C.append(l.createText(" ")),
                C.append(q.listNode),
                (q = q.nextIndex);
            else if (-1 == H.indent && !c && h) {
              d[h.getName()]
                ? ((C = H.element.clone(!1, !0)),
                  F != h.getDirection(1) && C.setAttribute("dir", F))
                : (C = new CKEDITOR.dom.documentFragment(l));
              var n = h.getDirection(1) != F,
                K = H.element,
                J = K.getAttribute("class"),
                E = K.getAttribute("style"),
                S =
                  C.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                  (e != CKEDITOR.ENTER_BR || n || E || J),
                O,
                T = H.contents.length,
                M;
              for (h = 0; h < T; h++)
                if (((O = H.contents[h]), k(O) && 1 < T))
                  S ? (M = O.clone(1, 1)) : C.append(O.clone(1, 1));
                else if (
                  ...
                  S
                    ? (G ||
                        ((G = l.createElement(I)),
                        C.append(G),
                        n && G.setAttribute("dir", F)),
                      E && G.setAttribute("style", E),
                      J && G.setAttribute("class", J),
                      M && (G.append(M), (M = null)),
                      G.append(O.clone(1, 1)))
                    : C.append(O.clone(1, 1));
            ...
            G = null;
            if (a.length <= q || Math.max(a[q].indent, 0) < w) break;
          }
          if (b)
            for (a = m.getFirst(); a; ) {
              if (
                ...
                for (f = c.getParent(); f && !(l = f.getDirection()); )
                  f = f.getParent();
                e == l && c.removeAttribute("dir");
              }
              a = a.getNextSourceNode();
            }
          return { listNode: m, nextIndex: q };
        },
      };
      var w = /^h[1-6]$/,
          ...
          if (this.state == CKEDITOR.TRISTATE_OFF) {
            ...
            if (k.getFirst(g)) {
              ...
              e.enterMode == CKEDITOR.ENTER_BR
                ...
                : h[0].fixBlock(
                    1,
                    e.enterMode == CKEDITOR.ENTER_P ? "p" : "div"
                  ),
                f.selectRanges(h);
          }
          for (
            var e = f.createBookmarks(!0),
              k = [],
              m = {},
              h = h.createIterator(),
              n = 0;
            ...
            x.type == CKEDITOR.NODE_ELEMENT &&
              "td" == x.getName() &&
              l.setStartAt(q.startNode, CKEDITOR.POSITION_AFTER_START);
            A.type == CKEDITOR.NODE_ELEMENT &&
              "td" == A.getName() &&
              l.setEndAt(q.endNode, CKEDITOR.POSITION_BEFORE_END);
            l = l.createIterator();
            for (
              l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF;
              (q = l.getNextParagraph());

            )
              if (!q.getCustomData("list_block")) {
                CKEDITOR.dom.element.setMarker(m, q, "list_block", 1);
                for (
                  var C = b.elementPath(q),
                    x = C.elements,
                    A = 0,
                    C = C.blockLimit,
                    F,
                ...
                A ||
                  ((A = C),
                  A.getCustomData("list_group_object_" + n)
                    ? A.getCustomData("list_group_object_" + n).contents.push(q)
                    : ((x = { root: A, contents: [q] }),
                      CKEDITOR.dom.element.setMarker(
                        m,
                        A,
          ...
          for (F = []; 0 < k.length; )
            if (((x = k.shift()), this.state == CKEDITOR.TRISTATE_OFF))
              if (d[x.root.getName()]) {
                ...
                for (
                  var G = n.root.getDocument(), I = void 0, H = void 0, q = 0;
                  q < C.length;
                  q++
                ) {
                  var K = C[q].getCustomData("listarray_index"),
                    I = A[K].parent;
                  I.is(this.type) ||
                    ((H = G.createElement(this.type)),
                    I.copyAttributes(H, { start: 1, type: 1 }),
                    H.removeStyle("list-style-type"),
                    (A[K].parent = H));
                }
                ...
                for (q = 0; q < C && (A = x.listNode.getChild(q)); q++)
                  A.getName() == this.type && l.push(A);
                ...
                1 == C.length &&
                  ...
                  C[0].moveChildren && C[0].moveChildren(x),
                  C[0].append(x),
                  (C[0] = x));
                l = l.contents[0].getParent();
                for (G = 0; G < C.length; G++)
                  l = l.getCommonAncestor(C[G].getParent());
                ...
                if (h && h.collapsed) {
                  ...
                  if (q) {
                    ...
                    (x = l(x))
                      ...
                      : (D.range.setStartAt(w, CKEDITOR.POSITION_AFTER_START),
                        D.range.setEnd(h.startContainer, h.startOffset),
                        (x = D.previous()) &&
                          x.type == CKEDITOR.NODE_ELEMENT &&
                          (x.getName() in d || x.is("li")) &&
                          (x.is("li") ||
                            (D.range.selectNodeContents(x),
                            D.reset(),
                            (D.evaluator = e),
                            (x = D.previous())),
                          (f = x),
                    ...
                    if (f) m(a, c, h), b.cancel();
                      ...
                      var A = k.contains(d);
                      A &&
                        h.checkBoundaryOfElement(A, CKEDITOR.START) &&
                        ((f = A.getFirst(g)),
                        h.checkBoundaryOfElement(f, CKEDITOR.START) &&
                          ((x = A.getPrevious(g)),
                          l(f)
                    ...
                    if (
                      (D.range.setEndAt(w, CKEDITOR.POSITION_BEFORE_END),
                      (q = (w = f.getLast(g)) && e(w) ? w : f),
                      (k = 0),
                      (x = D.next()) &&
                      x.type == CKEDITOR.NODE_ELEMENT &&
                      x.getName() in d &&
                      x.equals(w)
                        ? ((k = 1), (x = D.next()))
                        : h.checkBoundaryOfElement(q, CKEDITOR.END) && (k = 2),
                      k && x)
                    ) {
                      h = h.clone();
                    ...
                    D.range.setEndAt(w, CKEDITOR.POSITION_BEFORE_END),
                      (x = D.next()) &&
                        ...
                        x.is(d) &&
                        ((x = x.getFirst(g)),
                        k.block && h.checkStartOfBlock() && h.checkEndOfBlock()
                          ? (k.block.remove(),
                            h.moveToElementEditStart(x),
                            h.select())
                          : l(x)
    ...
    (function () {
      function a(a, b, c) {
        ...
        "wysiwyg" == a.mode &&
          ...
          a.fire("saveSnapshot"),
          b == CKEDITOR.ENTER_BR ? l(a, b, null, c) : d(a, b, null, c),
          a.fire("saveSnapshot"));
      }
      function f(a) {
      ...
      CKEDITOR.plugins.enterkey = {
        enterBlock: function (a, d, m, w) {
          if ((m = m || f(a))) {
            ...
            if (v && u) {
              if (p && (p.is("li") || p.getParent().is("li"))) {
                ...
                if (B.is("li"))
                  w || t
                    ? (w && t && m.remove(),
                      p[t ? "insertAfter" : "insertBefore"](B))
                    : p.breakParent(B);
                else {
                  if (a)
                    if (
                      (r.block.is("li")
                        ? ((B = q.createElement(
                          ...
                          x && B.setAttribute("dir", v),
                          D && B.setAttribute("style", D),
                          u && B.setAttribute("class", u),
                          p.moveChildren(B))
                        : (B = r.block),
                      w || t)
                    )
                      B[w ? "insertBefore" : "insertAfter"](m);
                    else p.breakParent(m), B.insertAfter(m);
                  else if ((p.appendBogus(!0), w || t))
                    for (; (q = p[w ? "getFirst" : "getLast"]()); )
                      q[w ? "insertBefore" : "insertAfter"](m);
                  else
                    for (p.breakParent(m); (q = p.getLast()); )
                      q.insertAfter(m);
                  p.remove();
                }
                z.selectBookmarks(y);
              ...
              if (p && p.getParent().is("blockquote")) {
                ...
                p.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1)) ||
                  p.getPrevious().remove();
                p.getNext().getFirst(CKEDITOR.dom.walker.invisible(1)) ||
                  p.getNext().remove();
            ...
            if ((v = m.splitBlock(z))) {
              ...
              p
                ? ((y = p.getParent()),
                  y.is("li") && (p.breakParent(y), p.move(p.getNext(), 1)))
                : d &&
                  (y = d.getParent()) &&
                  y.is("li") &&
                  (d.breakParent(y),
                  (y = d.getNext()),
                  m.moveToElementEditStart(y),
                  d.move(d.getPrevious()));
              if (r || a) {
                if (d) {
                  if (d.is("li") || (!h.test(d.getName()) && !d.is("pre")))
                    B = d.clone();
                } else p && (B = p.clone());
                B
                  ? w && !B.is("li") && B.renameNode(z)
                  : y && y.is("li")
                  ? (B = y)
                  : ((B = q.createElement(z)),
                    d && (t = d.getDirection()) && B.setAttribute("dir", t));
                if ((q = v.elementPath))
                ...
                !CKEDITOR.env.ie ||
                  !r ||
                  (a && d.getChildCount()) ||
                  (m.moveToElementEditStart(a ? d : B), m.select());
        ...
        enterBr: function (a, b, c, e) {
          if ((c = c || f(a))) {
            var l = c.document,
              m = c.checkEndOfBlock(),
              u = new CKEDITOR.dom.elementPath(
              ...
              ? (!e && m && h.test(p)
                  ? (m = r.getDirection())
                    ? ((l = l.createElement("div")),
                      l.setAttribute("dir", m),
                      l.insertAfter(r),
                      c.setStart(l, 0))
                    : (l.createElement("br").insertAfter(r),
                      CKEDITOR.env.gecko && l.createText("").insertAfter(r),
                      c.setStartAt(
                        r.getNext(),
                        CKEDITOR.env.ie
                          ? CKEDITOR.POSITION_BEFORE_START
                  ...
                  : ((a =
                    ...
                    c.insertNode(a),
                    CKEDITOR.env.needsBrFiller
                      ? (l.createText("﻿").insertAfter(a),
                        m && (r || u.blockLimit).appendBogus(),
                        (a.getNext().$.nodeValue = ""),
                        c.setStartAt(
                          a.getNext(),
                          CKEDITOR.POSITION_AFTER_START
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("entities", {
        afterInit: function (f) {
          ...
          function c(a) {
            return "force" != e.entities_processNumerical && l[a]
              ? l[a]
              : "\x26#" + a.charCodeAt(0) + ";";
          }
          var e = f.config;
    ...
    (function () {
      ...
      function b() {
        ...
        var d =
            c.config["filebrowser" + f(b.getName()) + "WindowWidth"] ||
            c.config.filebrowserWindowWidth ||
            "80%",
          b =
            c.config["filebrowser" + f(b.getName()) + "WindowHeight"] ||
      ...
      function m(a, d, g, l) {
        if (l && l.length)
          for (var w, q = l.length; q--; )
            if (
              ((w = l[q]),
              ("hbox" != w.type && "vbox" != w.type && "fieldset" != w.type) ||
                m(a, d, g, w.children),
              w.filebrowser)
            )
              if (
                ("string" == typeof w.filebrowser &&
                  (w.filebrowser = {
                ...
                void 0 === v &&
                  ((v = a.config["filebrowser" + f(d) + "BrowseUrl"]),
                  void 0 === v && (v = a.config.filebrowserBrowseUrl));
                v &&
                  ((w.onClick = b), (w.filebrowser.url = v), (w.hidden = !1));
              } else if (
                "QuickUpload" == w.filebrowser.action &&
                w["for"] &&
                ((v = w.filebrowser.url),
                void 0 === v &&
                  ((v = a.config["filebrowser" + f(d) + "UploadUrl"]),
                  void 0 === v && (v = a.config.filebrowserUploadUrl)),
                v)
              ) {
                var u = w.onClick;
                ...
                e(
                  a,
                  g.getContents(w["for"][0]).get(w["for"][1]),
                  w.filebrowser
                );
              }
      }
        ...
        if ("function" != typeof b || !1 !== b.call(this._.filebrowserSe))
          if (!e || !1 !== e.call(this._.filebrowserSe, a, b))
            if (
              ...
              if (((d = d.split(":")), (e = c.getContentElement(d[0], d[1]))))
                e.setValue(a), c.selectPage(d[0]);
      }
      ...
      CKEDITOR.on("dialogDefinition", function (a) {
        if (a.editor.plugins.filebrowser)
          for (var b = a.data.definition, c, d = 0; d < b.contents.length; ++d)
            if ((c = b.contents[d]))
              m(a.editor, a.data.name, b, c.elements),
                c.hidden &&
                  c.filebrowser &&
                  (c.hidden = !l(b, c.id, c.filebrowser));
      });
    })(),
    (function () {
      function a(a) {
            ...
            return function (d) {
              if ((m = a.editable())) {
                ...
                k
                  ? (z + y <= r.top
                      ? g("top")
                      : z + y > p.height - r.bottom
                      ? g("pin")
                      : g("bottom"),
                    (d = p.width / 2),
                    (d = e.floatSpacePreferRight
                      ? "right"
                      : 0 < r.left && r.right < p.width && r.width > u.width
                      ? "rtl" == e.contentsLangDirection
                        ? "right"
                        : "left"
                      : d - r.left > r.right - d
                      ? "left"
        ...
        render: function (a, e) {
          ...
          if (this.modes) {
            ...
            k &&
              ...
              (h +=
                k.state == CKEDITOR.TRISTATE_ON
                  ? "on"
                  : k.state == CKEDITOR.TRISTATE_DISABLED
                  ? "disabled"
                  : "off"));
          if (this.directional)
            a.on(
          ...
          k
            ? (n = a.getCommandKeystroke(k)) &&
              (w = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard, n))
            : (h += "off");
          var z = (n = this.name || this.command);
          this.icon &&
            !/\./.test(this.icon) &&
            ((z = this.icon), (this.icon = null));
          h = {
            id: d,
            name: n,
            iconName: z,
            ...
            ariaShortcut: w
              ? a.lang.common.keyboardShortcut + " " + w.aria
              : "",
            titleJs:
      ...
      CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
        ...
        proto: {
          ...
          setValue: function (a, c) {
            ...
            e &&
              (a || c
                ? e.removeClass("cke_combo_inlinelabel")
                : ((c = this.label), e.addClass("cke_combo_inlinelabel")),
              e.setText("undefined" != typeof c ? c : a));
          },
          getValue: function () {
            return this._.value || "";
          },
          ...
          0 !== m &&
            a.ui.addRichCombo("Format", {
              ...
              refresh: function () {
                ...
                if (b) {
                  if (b.isContextFor("p"))
                    for (var c in e) if (a.activeFilter.check(e[c])) return;
                  this.setState(CKEDITOR.TRISTATE_DISABLED);
                }
              },
            });
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("horizontalrule", {
        init: function (f) {
          f.blockless ||
            (f.addCommand("horizontalrule", a),
            f.ui.addButton &&
              f.ui.addButton("HorizontalRule", {
    ...
    (CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
      ...
      proto: {
        openTag: function (a) {
          ...
          this._.indent
            ? this.indentation()
            : f && f.breakBeforeOpen && (this.lineBreak(), this.indentation());
          this._.output.push("\x3c", a);
        ...
        attribute: function (a, f) {
          "string" == typeof f &&
            (this.forceSimpleAmpersand && (f = f.replace(/&amp;/g, "\x26")),
        ...
        closeTag: function (a) {
          ...
          this._.indent
            ? this.indentation()
            : f && f.breakBeforeClose && (this.lineBreak(), this.indentation());
          this._.output.push("\x3c/", a, "\x3e");
          "pre" == a && (this._.inPre = 0);
          f &&
            f.breakAfterClose &&
            (this.lineBreak(), (this._.needsSpace = f.needsSpace));
      ...
      CKEDITOR.plugins.link = {
        ...
        getEditorAnchors: function (a) {
          for (
            ...
            (f.data("cke-saved-name") || f.hasAttribute("name")) &&
              d.push({
                name: f.data("cke-saved-name") || f.getAttribute("name"),
                id: f.getAttribute("id"),
              });
          for (e = 0; (f = c.getItem(e++)); )
            (f = this.tryRestoreFakeAnchor(a, f)) &&
              d.push({
        ...
        parseLinkAttributes: function (a, b) {
          ...
          if (b) {
            if ((c = b.getAttribute("target")))
              D.target = { type: c.match(g) ? c : "frame", name: c };
            else if (
              (c =
              ...
              for (
                D.target = { type: "popup", name: c[1] };
                (t = v.exec(c[2]));

              )
                ("yes" != t[2] && "1" != t[2]) ||
                t[1] in { height: 1, width: 1, top: 1, left: 1 }
                  ? isFinite(t[2]) && (D.target[t[1]] = t[2])
                  : (D.target[t[1]] = !0);
        ...
        getLinkAttributes: function (c, d) {
          ...
          if (d.advanced) {
            for (var q in u) (e = d.advanced[u[q]]) && (g[q] = e);
    ...
    (function () {
        ...
        A(c, {
          ...
          mouseNear: function () {
            ...
            var b = a.holdDistance,
              c = this.size;
            return c &&
              m(a.mouse.y, c.top - b, c.bottom + b) &&
              m(a.mouse.x, c.left - b, c.right + b)
              ? !0
              : !1;
          },
          place: function () {
            ...
            e && f
              ? (k.top =
                  e.size.margin.bottom === f.size.margin.top
                    ? 0 | (e.size.bottom + e.size.margin.bottom / 2)
                    : e.size.margin.bottom < f.size.margin.top
                    ? e.size.bottom + e.size.margin.bottom
                    : e.size.bottom + e.size.margin.bottom - f.size.margin.top)
              : e
              ? f || (k.top = e.size.bottom + e.size.margin.bottom)
              : (k.top = f.size.top - f.size.margin.top);
            d.is(T) || m(k.top, b.scroll.y - 15, b.scroll.y + 5)
              ? ((k.top = a.inInlineMode ? 0 : b.scroll.y), this.look(T))
              : d.is(M) || m(k.top, b.pane.bottom - 5, b.pane.bottom + 15)
        ...
        c.lineChildren[0].on("mouseup", function (b) {
          ...
          h(
            ...
            function (b) {
              ...
              b[c.is(J) ? "insertBefore" : "insertAfter"](
                c.is(J) ? c.lower : c.upper
              );
            },
            !0
          );
      ...
      function h(a, b, c) {
        var d = new CKEDITOR.dom.range(a.doc),
          e = a.editor,
          f;
        G.ie && a.enterMode == CKEDITOR.ENTER_BR
          ? (f = a.doc.createText(da))
          : ((f =
              ((f = l(a.element, !0)) && f.data("cke-enter-mode")) ||
              a.enterMode),
            (f = new C(K[f], a.doc)),
            f.is("br") || a.doc.createText(da).appendTo(f));
          ...
          exec: (function () {
            ...
            return function (f) {
              ...
              if (
                ...
                g.is(N) &&
                (!e(a, g, !c) ||
                  ((h = e(a, g, !c)) && n(h) && h.is(a.triggers)))
                  ? d(g)
                  : ((h = b(a, f)),
                    n(h) &&
                      (e(a, h, !c)
                        ? (f = e(a, h, !c)) && n(f) && f.is(a.triggers) && d(h)
                        : d(h)));
              }
            };
          })(),
      ...
      function p(a) {
        ...
        if (!n(b) || w(b) || !v(a, b)) return null;
        t(a, b);
        return !h && 0 <= b.size.top && m(c.y, 0, b.size.top + e)
          ? ((a = a.inInlineMode || 0 === d.scroll.y ? T : V),
            new f([null, b, J, O, a]))
          : h &&
            b.size.bottom <= d.pane.height &&
            m(c.y, b.size.bottom - e, d.pane.height)
          ? ((a =
              a.inInlineMode ||
              m(b.size.bottom, d.pane.height - e, d.pane.height)
                ? M
                : V),
            new f([b, null, E, O, a]))
          : null;
      ...
      function z(a) {
        ...
        if (q) {
          ...
          h.equals(a.editable[p ? "getLast" : "getFirst"](a.isRelevant))
            ? (y(a),
              p &&
              m(c.y, h.size.bottom - g, d.pane.height) &&
              m(h.size.bottom, d.pane.height - g, d.pane.height)
                ? (l = M)
                : m(c.y, 0, h.size.top + g) && (l = T))
            : (l = V),
            (k = [null, h]
              [p ? "reverse" : "concat"]()
              .concat([
      ...
      function t(a, b, c) {
        ...
        if (!b.size) b.size = {};
        else if (b.size.ignoreScroll == c && b.size.date > new Date() - L)
          return null;
        ...
        init: function (a) {
          var c = a.config,
            ...
            m = {
              ...
              triggerOffset: l,
              holdDistance: 0 | (l * (c.magicline_holdDistance || 0.5)),
          ...
          a.on(
            ...
            function () {
              ...
              l.is(H.$inline) ||
                (m.inInlineMode &&
                  !q(l) &&
                  l.setStyles({ position: "relative", top: null, left: null }),
                d.call(this, m),
                D(m),
                l.attachListener(a, "beforeUndoImage", function () {
                  m.line.detach();
                }),
                l.attachListener(
                  a,
                    ...
                    if ("wysiwyg" == a.mode)
                      if (m.inInlineMode) {
                        ...
                        (c > d.left - e.x &&
                          ...
                          b > d.top - e.y &&
                          b < d.bottom - e.y) ||
                          (clearTimeout(t), (t = null), m.line.detach());
                    ...
                    if ("wysiwyg" == a.mode && !a.readOnly && !t) {
                      ...
                      t = setTimeout(function () {
                        ...
                        r &&
                          ...
                          !m.line.mouseNear() &&
                          (m.element = U(m, !0)) &&
                          ((m.trigger = p(m) || z(m) || X(m)) &&
                          !u(m, m.trigger.upper || m.trigger.lower)
                            ? m.line.attach().place()
                ...
                a.addCommand("accessPreviousSpace", k(m)),
                a.addCommand("accessNextSpace", k(m, !0)),
                a.setKeystroke([
                ...
                a.on("loadSnapshot", function () {
                  ...
                  for (e in { p: 1, br: 1, div: 1 })
                    for (
                      b = a.document.getElementsByTag(e), d = b.count();
                      d--;
        ...
        X = (function () {
          function b(e) {
            ...
            if (g && f.contains(g))
              ...
              g = f.getFirst(function (a) {
                return d(e, a);
              });
            if (h && f.contains(h))
              for (; !h.getParent().equals(f); ) h = h.getParent();
            else
              h = f.getLast(function (a) {
                return d(e, a);
              });
            if (!g || !h) return null;
            t(e, g);
            ...
            for (
              var f = Number.MAX_VALUE, l, p, q, v;
              h && !h.equals(g) && (p = g.getNext(e.isRelevant));

            )
              (l = Math.abs(c(e, g, p) - e.mouse.y)),
                l < f && ((f = l), (q = g), (v = p)),
                (g = p),
                t(e, g);
            if (!q || !v || !m(e.mouse.y, q.size.top, v.size.bottom))
              return null;
            k.upper = q;
            k.lower = v;
            return k.set(S, 8);
              ...
              exec: function () {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                  ...
                  for (r = a.container; (r = r.getParent()); )
                    r.setCustomData("maximize_saved_styles", b(r)),
                      r.setStyle("z-index", a.config.baseFloatZIndex - 5);
                  ...
                  v.setStyles({ left: -1 * u.x + "px", top: -1 * u.y + "px" });
                  CKEDITOR.env.gecko && e(a);
                } else if (this.state == CKEDITOR.TRISTATE_ON) {
                  k.removeListener("resize", f);
                  for (var r = [u, v], z = 0; z < r.length; z++)
                    c(r[z], r[z].getCustomData("maximize_saved_styles")),
                      r[z].removeCustomData("maximize_saved_styles");
                  for (r = a.container; (r = r.getParent()); )
                    c(r, r.getCustomData("maximize_saved_styles")),
                ...
                if ((r = this.uiItems[0]))
                  (u =
                    ...
                    r.getChild(1).setHtml(u),
                    r.setAttribute("title", u),
                    r.setAttribute("href", 'javascript:void("' + u + '");');
                "wysiwyg" == a.mode
                  ? g
                    ? (CKEDITOR.env.gecko && e(a),
                      a.getSelection().selectRanges(g),
                      (p = a.getSelection().getStartElement()) &&
                        p.scrollIntoView(!0))
                    : k.$.scrollTo(n.x, n.y)
                  : (g && ((p.selectionStart = g[0]), (p.selectionEnd = g[1])),
                    (p.scrollLeft = n[0]),
                    (p.scrollTop = n[1]));
                g = n = null;
                q = this.state;
      ...
      function a(a, c, e) {
        ...
        f
          ...
          : ((a = CKEDITOR.getUrl(
            ...
            CKEDITOR.scriptLoader.load(a, e, null, !0));
        return !f;
      }
      function f(a) {
        a.data.type = "html";
              ...
              if (
                ...
                var g = a(b, e, function () {
                  if (g) b.fire("paste", l);
                    ...
                    (k.dataValue = CKEDITOR.cleanWord(k.dataValue, b)),
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("pastetext", {
        ...
        init: function (f) {
          ...
          f.ui.addButton &&
            f.ui.addButton("PasteText", {
              label: f.lang.pastetext.button,
              command: "pastetext",
              toolbar: "clipboard,40",
            });
          if (f.config.forcePasteAsPlainText)
            f.on("beforePaste", function (a) {
          ...
          exec: function (a) {
            for (
              ...
              var h = d.createBookmark(),
                ...
                n = function (b) {
                  for (
                    var d = a.elementPath(b), e = d.elements, g = 1, h;
                    (h = e[g]) && !h.equals(d.block) && !h.equals(d.blockLimit);
                    g++
                  )
              ...
              if (g)
                for (
                  n(g), k = k.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT);
                  k && !k.equals(g);
                  ...
                  if (k.isReadOnly()) {
                    ...
                    (n = k.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT)),
                      ("img" == k.getName() && k.data("cke-realelement")) ||
                        !c(a, k) ||
                        (f.test(k.getName())
                          ? k.remove(1)
                          : (k.removeAttributes(b),
    ...
    CKEDITOR.plugins.add("resize", {
      init: function (a) {
        function f(b) {
          ...
          k &&
            (e = Math.max(c.resize_minWidth, Math.min(l, c.resize_maxWidth)));
          g &&
            (f = Math.max(c.resize_minHeight, Math.min(b, c.resize_maxHeight)));
          a.resize(k ? e : null, f);
        }
        function b() {
          ...
          a.document &&
            (a.document.removeListener("mousemove", f),
    ...
    CKEDITOR.plugins.add("scayt", {
        ...
        a.contextMenu &&
          ...
          (a.contextMenu.addListener(function (b, c) {
            var d = a.scayt,
              ...
              k;
            d &&
              (k = d.getSelectionNode()) &&
              ((e = f.menuGenerator(a, k)),
              d.showBanner(
                "." +
      ...
      addMenuItems: function (a) {
        ...
        for (
          var c = a.config.scayt_contextMenuItemsOrder.split("|"), e = 0;
          e < c.length;
          e++
        )
          c[e] = "scayt_" + c[e];
      ...
      addRule: function (a) {
        var f = CKEDITOR.plugins.scayt,
          ...
          l = function (b) {
            if (
              a.scayt &&
              (b.hasAttribute(f.options.data_attribute_name) ||
        ...
        b &&
          b.addRules({
            elements: {
              span: function (a) {
                var b =
                    a.hasClass(f.options.misspelled_word_class) &&
                    a.attributes[f.options.data_attribute_name],
                  c =
                    a.hasClass(f.options.problem_grammar_class) &&
        ...
        if (0 < f.length && "no_any_suggestions" !== f[0])
          if (b)
            for (b = 0; b < f.length; b++) {
              ...
              a.addCommand(
                h,
                this.createCommand(CKEDITOR.plugins.scayt.suggestions[b], m, l)
              );
      ...
      menuGenerator: function (a, f) {
        ...
        d
          ? ((c = c.scayt),
            (e = f.getAttribute(b.getScaytNodeAttributeName())),
            b.fire("getSuggestionsList", { lang: l, word: e }),
          ...
          : h &&
            ((c = c.grayt),
            (e = f.getAttribute(b.getGraytNodeAttributeName())),
            (h = b.getProblemDescriptionText(e, l)),
            c.grayt_problemdescription &&
              h &&
              (c.grayt_problemdescription.label = h),
            b.fire("getGrammarSuggestionsList", { lang: l, phrase: e }),
            (e = this.buildSuggestionMenuItems(
              a,
              CKEDITOR.plugins.scayt.suggestions,
              d
        ...
        for (var k in c)
          (d &&
            -1 == CKEDITOR.tools.indexOf(m, k.replace("scayt_", "")) &&
            "all" != a.config.scayt_contextCommands) ||
            ((e[k] =
              "undefined" != typeof c[k].state
                ? c[k].state
                : CKEDITOR.TRISTATE_OFF),
            "function" !== typeof c[k].verification ||
              c[k].verification(a) ||
              delete e[k],
            a.addCommand(k, { exec: c[k].exec }),
            a.addMenuItem(k, {
    ...
    (CKEDITOR.plugins.scayt = {
      ...
      replaceOldOptionsNames: function (a) {
        for (var f in a)
          f in this.backCompatibilityMap &&
            ((a[this.backCompatibilityMap[f]] = a[f]), delete a[f]);
      },
        ...
        this.loadScaytLibrary(a, function (a) {
          ...
          if (m) {
            ...
            a.config.scayt_serviceHost &&
              (m.service_host = a.config.scayt_serviceHost);
            a.config.scayt_servicePort &&
              (m.service_port = a.config.scayt_servicePort);
            a.config.scayt_servicePath &&
              (m.service_path = a.config.scayt_servicePath);
            "boolean" === typeof a.config.scayt_ignoreAllCapsWords &&
              (m["ignore-all-caps-words"] = a.config.scayt_ignoreAllCapsWords);
            "boolean" === typeof a.config.scayt_ignoreDomainNames &&
              (m["ignore-domain-names"] = a.config.scayt_ignoreDomainNames);
            "boolean" === typeof a.config.scayt_ignoreWordsWithMixedCases &&
              (m["ignore-words-with-mixed-cases"] =
                a.config.scayt_ignoreWordsWithMixedCases);
            "boolean" === typeof a.config.scayt_ignoreWordsWithNumbers &&
              (m["ignore-words-with-numbers"] =
                a.config.scayt_ignoreWordsWithNumbers);
            var l;
            try {
              l = e(m);
          ...
          return function () {
            ...
            if (
              ...
              if ((c = "ready" == this.status))
                var f = e.removeMarkupFromString(this.getSnapshot()),
        ...
        a[f] = CKEDITOR.tools.override(a[f], function (a) {
          return function (c) {
            ...
            CKEDITOR.plugins.scayt &&
              ...
              c.editor.scayt &&
              ((this.contents = e.removeMarkupFromString(f) || ""),
              (c.contents = e.removeMarkupFromString(l) || ""));
      ...
      CKEDITOR.plugins.add("showborders", {
        ...
        init: function (f) {
          ...
          f.on("removeFormatCleanup", function (a) {
            a = a.data;
            f.getCommand("showborders").state == CKEDITOR.TRISTATE_ON &&
              a.is("table") &&
          ...
          if (
            ...
            (a.setup = CKEDITOR.tools.override(a.setup, function (a) {
              ...
              (a.commit = CKEDITOR.tools.override(a.commit, function (a) {
                return function (b, f) {
                  a.apply(this, arguments);
                  parseInt(f.getAttribute("border"), 10) ||
        ...
        init: function (f) {
          ...
          if (f.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
            ...
            f.addMode("source", function (c) {
              ...
              e.setStyles(
                CKEDITOR.tools.extend(
                  ...
                  CKEDITOR.tools.cssVendorPrefix(
                    "tab-size",
                    f.config.sourceAreaTabSize || 4
                  )
                )
              );
              e.setAttribute("dir", "ltr");
              e.addClass("cke_source")
                .addClass("cke_reset")
              ...
              CKEDITOR.env.ie &&
                (e.attachListener(f, "resize", b, e),
                e.attachListener(CKEDITOR.document.getWindow(), "resize", b, e),
                CKEDITOR.tools.setTimeout(b, 0, e));
      ...
      CKEDITOR.plugins.add("stylescombo", {
        ...
        init: function (a) {
          ...
          a.on("stylesSet", function (b) {
            if ((b = b.data.styles)) {
              for (var d, h, k, g = 0, n = b.length; g < n; g++)
                ((d = b[g]),
                (a.blockless && d.element in CKEDITOR.dtd.$block) ||
                  ("string" == typeof d.type &&
                    !CKEDITOR.style.customHandlers[d.type]) ||
                  ((h = d.name),
                  (d = new CKEDITOR.style(d)),
                  a.filter.customConfig && !a.filter.check(d))) ||
                  ((d._name = h),
                  (d._.enterMode = f.enterMode),
                  (d._.type = k = d.assignedTo || d.type),
                  (d._.weight =
                    g +
                    1e3 *
                      (k == CKEDITOR.STYLE_OBJECT
                        ? 1
                        : k == CKEDITOR.STYLE_BLOCK
                        ? 2
                        : 3)),
                  (c[h] = d),
                  e.push(d),
            ...
            init: function () {
              ...
              for (m = e.length; g < m; g++)
                (a = e[g]),
                  ...
                  (k = a._.type),
                  k != f &&
                    (this.startGroup(b["panelTitle" + String(k)]), (f = k)),
                  this.add(
                    c,
    ...
    (function () {
          ...
          exec: function (b) {
            if (b.editable().hasFocus) {
              ...
              if (
                ...
                var c = b.createRange(),
                  f = CKEDITOR.tools.tryThese(
                    function () {
                      var b =
                        d.getParent().$.cells[d.$.cellIndex + (a ? -1 : 1)];
                ...
                if (f || a)
                  ...
                  for (
                    var k = d.getAscendant("table").$,
                      f = d.getParent().$.cells,
                      k = new CKEDITOR.dom.element(k.insertRow(-1), b.document),
                      g = 0,
                      n = f.length;
                    g < n;
                    g++
                    ...
                    k.append(
                      new CKEDITOR.dom.element(f[g], b.document).clone(!1, !1)
                    ).appendBogus();
      ...
      var f = { editorFocus: !1, modes: { wysiwyg: 1, source: 1 } },
        b = {
          exec: function (a) {
      ...
      CKEDITOR.plugins.add("tab", {
        init: function (e) {
          for (
            var m = !1 !== e.config.enableTabKeyTools,
          ...
          if (m)
            e.on("key", function (a) {
              ((9 == a.data.keyCode && e.execCommand("selectNextCell")) ||
                (a.data.keyCode == CKEDITOR.SHIFT + 9 &&
                  e.execCommand("selectPreviousCell"))) &&
                a.cancel();
            });
    ...
    (CKEDITOR.dom.element.prototype.focusNext = function (a, f) {
      ...
      if (0 >= b)
        ...
        for (
          d = this.getDocument().getBody().getFirst();
          (d = d.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT));
          ...
          if (!c)
            if (!e && d.equals(this)) {
              if (((e = !0), a)) {
                if (!(d = d.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT)))
                  break;
                c = 1;
              }
    ...
    (function () {
      ...
      function f(b, c) {
        for (
          var d = a(b),
            ...
            d = new CKEDITOR.dom.element(f.$.rows[k]),
            h = c ? h : k,
            g = c ? g : d,
            d = CKEDITOR.tools.buildTableMap(f),
            f = d[h],
            h = c ? d[h - 1] : d[h + 1],
            d = d[0].length,
          ...
          1 < f[k].rowSpan && h && f[k] == h[k]
            ? ((l = f[k]), (l.rowSpan += 1))
            : ((l = new CKEDITOR.dom.element(f[k]).clone()),
      ...
      function b(c) {
        if (c instanceof CKEDITOR.dom.selection) {
          ...
          for (
            ...
            for (
              var k = f[h], l = new CKEDITOR.dom.element(e.$.rows[h]), m = 0;
              m < k.length;
              m++
            ) {
              ...
              1 == n.$.rowSpan
                ...
                : (--n.$.rowSpan,
                  w == h &&
                    ((w = f[h + 1]),
                    w[m - 1]
                      ? n.insertAfter(new CKEDITOR.dom.element(w[m - 1]))
                      : new CKEDITOR.dom.element(e.$.rows[h + 1]).append(
                          n,
                          1
                        )));
              m += n.$.colSpan - 1;
          ...
          e = new CKEDITOR.dom.element(
            f[g + 1] || (0 < c ? f[c - 1] : null) || e.$.parentNode
          );
        ...
        c instanceof CKEDITOR.dom.element &&
          ...
          1 == e.$.rows.length ? e.remove() : c.remove());
        return null;
      }
      function c(a, b) {
        for (var c = b ? Infinity : 0, d = 0; d < a.length; d++) {
          ...
          e = a[d];
          for (
            var f = b, g = e.getParent().$.cells, h = 0, k = 0;
            k < g.length;
            k++
          ) {
            var l = g[k],
      ...
      function e(b, d) {
        for (
          ...
          f.push(h[l][g]), e.push(d ? h[l][g - 1] : h[l][g + 1]);
        for (l = 0; l < k; l++)
          f[l] &&
            (1 < f[l].colSpan && e[l] == f[l]
              ? ((g = f[l]), (g.colSpan += 1))
              : ((g = new CKEDITOR.dom.element(f[l]).clone()),
                g.removeAttribute("colSpan"),
                g.appendBogus(),
                g[d ? "insertBefore" : "insertAfter"].call(
                  g,
                  new CKEDITOR.dom.element(f[l])
                ),
                (g = g.$)),
            (l += g.rowSpan - 1));
      }
      ...
      function l(b) {
        if (b instanceof CKEDITOR.dom.selection) {
          ...
          a: {
            ...
            for (f = 0; (h = b[f++]); )
              if (
                ((k = h.getPrevious()) && !k.getCustomData("delete_cell")) ||
                ((k = h.getNext()) && !k.getCustomData("delete_cell"))
              ) {
            ...
            (k = k.getPrevious())
              ? (e = k.getLast())
              : ((k = b[e].getParent()),
                (e = (k = k.getNext()) ? k.getChild(0) : null));
          }
      ...
      function k(b, c, d) {
        var e = a(b),
          f;
        if (
          (c ? 1 != e.length : 2 > e.length) ||
          ((f = b.getCommonAncestor()) &&
            f.type == CKEDITOR.NODE_ELEMENT &&
            f.is("table"))
        )
          return !1;
        ...
        if (c) {
          ...
          try {
            ...
            A =
              k["up" == c ? n - C : "down" == c ? n + C : n][
                "left" == c ? w - g : "right" == c ? w + g : w
              ];
          } catch (F) {
            return !1;
          }
          if (!A || b.$ == A) return !1;
          e["up" == c || "left" == c ? "unshift" : "push"](
            new CKEDITOR.dom.element(A)
          );
        }
        c = b.getDocument();
        ...
        for (c = 0; c < e.length; c++) {
          ...
          d ||
            ((E = g),
            (S = E.getBogus()) && S.remove(),
            E.trim(),
            g.getChildren().count() &&
              (K == G ||
                !J ||
                (J.isBlockBoundary && J.isBlockBoundary({ br: 1 })) ||
                ((G = I.getLast(CKEDITOR.dom.walker.whitespaces(!0))),
                !G || (G.is && G.is("br")) || I.append("br")),
              g.moveChildren(I)),
        ...
        if (1 < m) {
          ...
          for (
            var m = Math.floor(m / 2),
              e = k + n,
              f = new CKEDITOR.dom.element(f.$.rows[e]),
              g = h(g, e),
              w,
              e = d.clone(),
              k = 0;
          ...
          u(
            ...
            h({
              ...
              exec: function (b) {
                ...
                for (
                  var f = CKEDITOR.tools.buildTableMap(b),
                    g,
                    h,
                    k = [],
                    l = 0,
                  ...
                  for (var n = 0, q = f[l].length; n < q; n++)
                    f[l][n] == c.$ && (g = n), f[l][n] == e.$ && (h = n);
                for (l = g; l <= h; l++)
                  for (n = 0; n < f.length; n++)
                    (e = f[n]),
                      ...
                      e.$ &&
                        (1 == e.$.colSpan ? e.remove() : --e.$.colSpan,
                        (n += e.$.rowSpan - 1),
                        c.$.cells.length || k.push(c));
              ...
              tablecell: {
                ...
                getItems: function () {
                  ...
                  return {
                    ...
                    tablecell_merge: k(b, null, !0)
                      ? CKEDITOR.TRISTATE_OFF
                      : CKEDITOR.TRISTATE_DISABLED,
                    tablecell_merge_right: k(b, "right", !0)
                      ? CKEDITOR.TRISTATE_OFF
                      : CKEDITOR.TRISTATE_DISABLED,
                    tablecell_merge_down: k(b, "down", !0)
                      ? CKEDITOR.TRISTATE_OFF
                      : CKEDITOR.TRISTATE_DISABLED,
    ...
    (CKEDITOR.tools.buildTableMap = function (a) {
      ...
      for (var f = -1, b = [], c = 0; c < a.length; c++) {
        ...
        for (var e = -1, m = 0; m < a[c].cells.length; m++) {
          ...
          for (e++; b[f][e]; ) e++;
          for (
            var d = isNaN(l.colSpan) ? 1 : l.colSpan,
              l = isNaN(l.rowSpan) ? 1 : l.rowSpan,
              h = 0;
            h < l;
            h++
          ) {
    ...
    (function () {
      function a(a) {
        function b() {
          for (
            var g = c(),
              h = CKEDITOR.tools.clone(a.config.toolbarGroups) || f(a),
              k = 0;
            k < h.length;
            k++
          ) {
          ...
          if (c.length) {
            ...
            for (var d; (d = c.shift()); )
              (d = "string" == typeof d ? d : d.name),
                (k && -1 != CKEDITOR.tools.indexOf(k, d)) ||
                  ((d = a.ui.create(d)) && a.addFeature(d) && b.items.push(d));
          }
        }
        function h(a) {
          var b = [],
          ...
          for (c = 0; c < a.length; ++c)
            (e = a[c]),
              ...
              "/" == e
                ? b.push(e)
                : CKEDITOR.tools.isArray(e)
                ? (d(f, CKEDITOR.tools.clone(e)), b.push(f))
                : e.items &&
                      ...
                      ((c =
                        9 == b
                          ? (c ? c.next : a.toolbar.next) ||
                            e.toolbox.toolbars[0]
                          : (c ? c.previous : a.toolbar.previous) ||
                            e.toolbox.toolbars[e.toolbox.toolbars.length - 1]),
                      c.items.length)
                    )
                      for (
                        a = c.items[f ? c.items.length - 1 : 0];
                        a && !a.focus;
            ...
            if (c.data.space == e.config.toolbarLocation) {
              ...
              var f = CKEDITOR.tools.getNextId(),
                k = [
                  ...
                  f,
                  '" class\x3d"cke_voice_label"\x3e',
                  e.lang.toolbar.toolbars,
                  "\x3c/span\x3e",
                  '\x3cspan id\x3d"' +
                    e.ui.spaceId("toolbox") +
                ...
                g,
                m;
              e.config.toolbarCanCollapse &&
                e.elementMode != CKEDITOR.ELEMENT_MODE_INLINE &&
                k.push(
                  '\x3cspan class\x3d"cke_toolbox_main"' +
                    (f ? "\x3e" : ' style\x3d"display:none"\x3e')
                );
              for (
                var w = e.toolbox.toolbars, q = a(e), v = q.length, u = 0;
                u < v;
                u++
              ) {
                var r,
                  ...
                  y;
                if (B)
                  if ((g && (k.push("\x3c/span\x3e"), (m = g = 0)), "/" === B))
                    k.push(
                          ...
                          if (!p) {
                            ...
                            k.push(
                              ...
                              '" class\x3d"cke_toolbar' +
                                (t ? ' cke_toolbar_last"' : '"'),
                              z ? ' aria-labelledby\x3d"' + r + '_label"' : "",
                            ...
                            var F = w.push(p) - 1;
                            0 < F &&
                              ((p.previous = w[F - 1]), (p.previous.next = p));
                          }
                          A
                            ? g ||
                              (k.push(
              ...
              if (
                ...
                k.push(
                  '\x3ca title\x3d"' +
                    (f
                      ? e.lang.toolbar.toolbarCollapse
                      : e.lang.toolbar.toolbarExpand) +
                    '" id\x3d"' +
                    e.ui.spaceId("toolbar_collapser") +
                    '" tabIndex\x3d"-1" class\x3d"cke_toolbox_collapser'
                );
                f || k.push(" cke_toolbox_collapser_min");
                k.push(
                  '" onclick\x3d"CKEDITOR.tools.callFunction(' + G + ')"\x3e',
      ...
      CKEDITOR.ui.prototype.addToolbarGroup = function (a, b, c) {
        ...
        if (c) {
          if (
            (c = CKEDITOR.tools.search(d, function (a) {
              return a.name == c;
            }))
          ) {
            !c.groups && (c.groups = []);
      ...
      b.prototype = {
        ...
        update: function (a) {
          if (!this.locked) {
            ...
            for (
              var b = this.index, e = this.snapshots;
              0 < b && this.currentImage.equalsContent(e[b - 1]);
          ...
          if (b || a) {
            ...
            for (var c = 0; c < b.length; c++) {
              var e = b[c],
                f = a[c];
              if (
                e.startOffset != f.startOffset ||
                e.endOffset != f.endOffset ||
                !CKEDITOR.tools.arrayCompare(e.start, f.start) ||
                !CKEDITOR.tools.arrayCompare(e.end, f.end)
              )
                return !1;
            }
          }
    ...
    (function () {
      function a(a) {
          ...
          g.attachListener(g, "keyup", function () {
            ...
            c &&
              (1 != b.count() ||
                ...
                b.getItem(0).hasAttribute("data-cke-temp") ||
        ...
        (k = d.getElementById("cke_basetagscrpt")) &&
        ...
        if (
          ...
          d.getDocumentElement().on("mousedown", function (a) {
            a.data.getTarget().is("html") &&
              setTimeout(function () {
                c.editable().focus();
              });
          ...
          a.addMode("wysiwyg", function (b) {
            ...
            if (n) {
              var g = CKEDITOR.tools.getNextId(),
                w = CKEDITOR.dom.element.createFromHtml(
                  '\x3cspan id\x3d"' +
                    g +
                    '" class\x3d"cke_voice_label"\x3e' +
                    n +
      ...
      c = CKEDITOR.tools.createClass({
        ...
        proto: {
          setData: function (a, c) {
            var f = this.editor;
            if (c)
              this.setHtml(a), this.fixInitialSelection(), f.fire("dataReady");
            else {
              ...
              h
                ...
                : (a =
                    ...
                    (d.bodyId ? ' id\x3d"' + d.bodyId + '"' : "") +
                    (d.bodyClass ? ' class\x3d"' + d.bodyClass + '"' : "") +
                    "\x3e" +
                    a +
          ...
          getData: function (a) {
            ...
            var b = a.config,
              ...
              k = this.getDocument(),
              c = c
                ? k.getDocumentElement().getOuterHtml()
                : k.getBody().getHtml();
            CKEDITOR.env.gecko &&
          ...
          detach: function () {
            ...
            f && f.getParent()
              ? (f.clearCustomData(),
                (a = f.removeCustomData("onResize")) && a.removeListener(),
                f.remove())
